...
#add module "axi_slave_xtor"
xgen_add module axi_slave_xtor i_axi_slave_xtor
xgen_add xactor axi_slave_xtor axi4_slave i_axi_slave
xgen_set axi_slave_xtor i_axi_slave KEEP_BURSTS 1
xgen_set axi_slave_xtor i_axi_slave DATA_WIDTH 64
xgen_set axi_slave_xtor i_axi_slave XACTOR_ID 4
xgen_set axi_slave_xtor i_axi_slave ADDR_WIDTH 32
#xgen_set axi_slave_xtor i_axi_slave INTERLEAVE_DEPTH 1
xgen_set axi_slave_xtor i_axi_slave UMR_INPORT_FIFO_DEPTH 2048
#xgen_set axi_slave_xtor i_axi_slave OUTSTANDING_XACTIONS 256
xgen_set axi_slave_xtor i_axi_slave XACTOR_COMMENT "i_axi_slave_xtor"
xgen_set axi_slave_xtor i_axi_slave UMR_OUTPORT_FIFO_DEPTH 4095
# create output
xgen_create
