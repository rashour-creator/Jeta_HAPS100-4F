...
module i_axi_a2x_2_DW_axi_a2x_b_buf (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_IDW                         = `i_axi_a2x_2_A2X_IDW;
  localparam A2X_BRESPW                      = `i_axi_a2x_2_A2X_BRESPW;
  ...
  //*************************************************************************************
  // Return OK Response
  assign bresp_o     = `i_axi_a2x_2_AOKAY;
  // Return Write ID 
