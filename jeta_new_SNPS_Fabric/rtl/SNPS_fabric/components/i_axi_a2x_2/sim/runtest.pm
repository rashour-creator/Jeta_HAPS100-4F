...
@ISA = qw(Exporter);
use lib "/remote/sdgedt/tools/reem/SNPS_FABRIC/Subsystem1/components/i_axi_a2x_2/scratch/rce/perl/testJSONLib/lib";
use testjson;

my $PATH_TO_JSON_PL_SCRIPTS="/remote/sdgedt/tools/reem/SNPS_FABRIC/Subsystem1/components/i_axi_a2x_2/scratch/rce/perl/testJSONLib/lib";

my $file_prefix="";

my $design_prefix="i_axi_a2x_2_";

my $macro_prefix="i_axi_a2x_2_";
...
if (exists $main::ccparams{'i_axi_a2x_2_USE_FOUNDATION'}) 
   {
if ($main::ccparams{'i_axi_a2x_2_USE_FOUNDATION'} eq 1) 
     {
      if (exists $ENV{SYNOPSYS}) {
