...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/axi_dev_br/src/DW_axi_a2x_h2x_et.v#5 $ 
**
** --------------------------------------------------------------------*/
...
//*********************************************************
module i_axi_a2x_2_DW_axi_a2x_h2x_et (/*AUTOARG*/
  // Outputs
  data_o, 
  // Inputs
  data_i, 
  ...
  generate if (`i_axi_a2x_2_A2X_PP_ENDIAN==1) begin: PP_ENDIAN
  ...
  else if (`i_axi_a2x_2_A2X_PP_ENDIAN==2) begin 
