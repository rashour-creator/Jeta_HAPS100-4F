...
//==============================================================================
`ifndef i_axi_a2x_2___GUARD__DW_AXI_A2X_CC_CONSTANTS__VH__
`define i_axi_a2x_2___GUARD__DW_AXI_A2X_CC_CONSTANTS__VH__
...
`define i_axi_a2x_2_USE_FOUNDATION 1

`define i_axi_a2x_2_A2X_USE_FOUNDATION
...
`define i_axi_a2x_2_A2X_LOWPWR_IF 0
...
`define i_axi_a2x_2_A2X_LOWPWR_NOPX_CNT 2
...
`define i_axi_a2x_2_A2X_PP_MODE 1
...
`define i_axi_a2x_2_A2X_AHB_INTERFACE_TYPE 0
...
`define i_axi_a2x_2_A2X_HAS_EXTD_MEMTYPE 0
...
`define i_axi_a2x_2_A2X_HAS_SECURE_XFER 0
...
`define i_axi_a2x_2_A2X_HAS_EXCL_XFER 0
...
`define i_axi_a2x_2_A2X_AXI_INTERFACE_TYPE 1


`define i_axi_a2x_2_A2X_INT_AXI3 0


`define i_axi_a2x_2_A2X_INT_LTW 1


// `define i_axi_a2x_2_A2X_HAS_AXI3


`define i_axi_a2x_2_A2X_HAS_AXI4


// `define i_axi_a2x_2_A2X_HAS_ACELITE
...
`define i_axi_a2x_2_A2X_AHB_LITE_MODE 0
...
`define i_axi_a2x_2_A2X_AHB_SCALAR_HRESP 0
...
`define i_axi_a2x_2_A2X_AHB_SPLIT_MODE 1
`define i_axi_a2x_2_AHB_SPLIT_MODE
...
`define i_axi_a2x_2_A2X_NUM_AHBM 8
...
`define i_axi_a2x_2_A2X_HREADY_LOW_PERIOD 100
...
//  - AHB to AXI 
//  - AXI to AXI
`define i_axi_a2x_2_A2X_LOCKED 0
...
`define i_axi_a2x_2_A2X_CLK_MODE 0
...
`define i_axi_a2x_2_A2X_PP_SYNC_DEPTH 0


`define i_axi_a2x_2_F_SYNC_TYPE_PP 1
...
//  - 3 - Three-stage synchronization, all stages positive edge 
//  If one port has a synchronization depth of 0, the other port must also be 0.
`define i_axi_a2x_2_A2X_SP_SYNC_DEPTH 0


`define i_axi_a2x_2_F_SYNC_TYPE_SP 1


`define i_axi_a2x_2_A2X_SYNC_DEPTH_BUSY 2
...
`define i_axi_a2x_2_A2X_PP_IDW 6


`define i_axi_a2x_2_A2X_IDW 6


// Name:         A2X_SP_IDW
// Default:      6 (A2X_PP_IDW)
// Values:       1, ..., 16
// 
// Specifies the ID width on the DW_axi_a2x Secondary Port.
`define i_axi_a2x_2_A2X_SP_IDW 10
...
`define i_axi_a2x_2_A2X_PP_AW 32


`define i_axi_a2x_2_A2X_AW 32


// Name:         A2X_SP_AW
// Default:      32 (A2X_PP_AW)
// Values:       32, ..., 64
// 
// Specifies the Address Bus Width of the Secondary Port.
`define i_axi_a2x_2_A2X_SP_AW 32

// Specifies the number of bits to the AXI boundary; 12 bits for a 4K boundary. 

`define i_axi_a2x_2_A2X_BOUNDARY_W 12
...
`define i_axi_a2x_2_A2X_PP_BLW 8
...
//  - Maximum supported AXI length is 256 (2^8) 
// With Locked mode on, a BLW of 4 is supported.
`define i_axi_a2x_2_A2X_SP_BLW 8


`define i_axi_a2x_2_A2X_BLW 8


`define i_axi_a2x_2_A2X_MAX_ALEN 256
...
`define i_axi_a2x_2_A2X_PP_DW 64
...
`define i_axi_a2x_2_A2X_SP_DW 64


`define i_axi_a2x_2_A2X_RS_RATIO 1

`define i_axi_a2x_2_A2X_RS_RATIO_LOG2 0
...
`define i_axi_a2x_2_A2X_PP_ENDIAN 0
...
`define i_axi_a2x_2_A2X_SP_ENDIAN 0
...
`define i_axi_a2x_2_A2X_WBUF_MODE 0
...
`define i_axi_a2x_2_A2X_HCBUF_MODE 1


`define i_axi_a2x_2_A2X_APB_MODE 0
...
`define i_axi_a2x_2_A2X_HCSNF_WLEN 1
...
`define i_axi_a2x_2_A2X_SNF_AWLEN_DFLT 8

// Sets the minimum value of the Store-Forward AWLEN length.

`define i_axi_a2x_2_A2X_SNF_AWLEN_MIN 4
...
`define i_axi_a2x_2_A2X_HINCR_HCBCNT 1
...
// A2X_AHB_LITE_MODE=0.
`define i_axi_a2x_2_A2X_SINGLE_RBCNT 1
...
`define i_axi_a2x_2_A2X_SINGLE_WBCNT 1

// Sets the minimum value of the HINCR length.

`define i_axi_a2x_2_A2X_HINCR_WBCNT_MIN 0
...
//   
//       A2X_PP_DW/A2X_SP_DW.
`define i_axi_a2x_2_A2X_HINCR_WBCNT_MAX 0


`define i_axi_a2x_2_A2X_HINCR_AWLEN_DFLT 0

`define i_axi_a2x_2_A2X_HINCR_AWLEN_MIN 0
...
`define i_axi_a2x_2_A2X_BRESP_MODE 1
...
`define i_axi_a2x_2_A2X_BRESP_ORDER 0
...
`define i_axi_a2x_2_A2X_OSW_EN 0
...
// DW_axi_a2x Databook.
`define i_axi_a2x_2_A2X_NUM_UWID 1
...
// For more information on usage for this parameter, refer to "Outstanding Transaction Limits" in the DesignWare 
// DW_axi_a2x Databook.
`define i_axi_a2x_2_A2X_SP_OSAW_LIMIT_P1 3


`define i_axi_a2x_2_A2X_SP_OSAW_LIMIT 2

`define i_axi_a2x_2_A2X_OSAW_LIMIT 2


// Name:         A2X_PP_OSAW_LIMIT_P1
// Default:      3 ((A2X_OSW_EN==1)? 16 : 3)
// Values:       3, ..., 64
...
// For more information on usage for this parameter, refer to "Outstanding Transaction Limits" in the DesignWare 
// DW_axi_a2x Databook.
`define i_axi_a2x_2_A2X_PP_OSAW_LIMIT_P1 3


`define i_axi_a2x_2_A2X_PP_OSAW_LIMIT 2
...
// For more information on usage for this parameter, refer to "Outstanding Transaction Limits" in the DesignWare 
// DW_axi_a2x Databook.
`define i_axi_a2x_2_A2X_B_OSW_LIMIT_P1 3


`define i_axi_a2x_2_A2X_B_OSW_LIMIT 2

`define i_axi_a2x_2_A2X_OSW_LIMIT 2
...
`define i_axi_a2x_2_A2X_RBUF_MODE 0
...
`define i_axi_a2x_2_A2X_HCSNF_RLEN 1
...
`define i_axi_a2x_2_A2X_SNF_ARLEN_DFLT 8

// Sets the minimum value of the Read Store-Forward ARLEN Length.

`define i_axi_a2x_2_A2X_SNF_ARLEN_MIN 4
...
`define i_axi_a2x_2_A2X_AHB_RRECALL_DEPTH 2
...
`define i_axi_a2x_2_A2X_AHB_EBT_MODE 1

// Sets the minimum value of the HINCR length.

`define i_axi_a2x_2_A2X_HINCR_RBCNT_MIN 0
...
`define i_axi_a2x_2_A2X_HINCR_RBCNT_MAX 0


`define i_axi_a2x_2_A2X_LKMODE_MAX_PREFETCH 16


`define i_axi_a2x_2_A2X_HINCR_ARLEN_DFLT 0

`define i_axi_a2x_2_A2X_HINCR_ARLEN_MIN 0
...
`define i_axi_a2x_2_A2X_READ_INTLEV 0


// Name:         A2X_READ_ORDER
// Default:      In-Order ((A2X_READ_INTLEV==1)? 1 : 0)
// Values:       In-Order (0), Out-of-Order (1)
...
//  channel.
`define i_axi_a2x_2_A2X_READ_ORDER 0
...
//  For more information on usage for this parameter, refer to "Outstanding Transaction Limits" in the DesignWare 
//  DW_axi_a2x Databook.
`define i_axi_a2x_2_A2X_NUM_URID 1


// Name:         A2X_OSR_LIMIT_P1
// Default:      3 ((A2X_OSR_EN==1)? 16 : 3)
// Values:       3, ..., 128
...
// For more information on usage for this parameter, refer to "Outstanding Transaction Limits" in the DesignWare 
// DW_axi_a2x Databook.
`define i_axi_a2x_2_A2X_OSR_LIMIT_P1 3


`define i_axi_a2x_2_A2X_OSR_LIMIT 2
...
`define i_axi_a2x_2_A2X_A_UBW 0
...
// aligned to data.
`define i_axi_a2x_2_A2X_USER_SIGNAL_XFER_MODE 0
...
`define i_axi_a2x_2_A2X_WUSER_BITS_PER_BYTE 0
...
`define i_axi_a2x_2_A2X_RUSER_BITS_PER_BYTE 0
...
`define i_axi_a2x_2_A2X_W_UBW 0
...
`define i_axi_a2x_2_A2X_R_UBW 0
...
`define i_axi_a2x_2_A2X_AWSBW 0
...
// address sideband (AXI3)/user (AXI4/ACE-Lite) ports are removed.
`define i_axi_a2x_2_A2X_ARSBW 0
...
`define i_axi_a2x_2_A2X_INC_QOS 0


// `define i_axi_a2x_2_A2X_HAS_QOS
...
`define i_axi_a2x_2_A2X_INC_REGION 0


// `define i_axi_a2x_2_A2X_HAS_REGION
...
`define i_axi_a2x_2_A2X_AW_FIFO_DEPTH 4
...
`define i_axi_a2x_2_A2X_WD_FIFO_DEPTH 16
...
`define i_axi_a2x_2_A2X_BRESP_FIFO_DEPTH 2
...
`define i_axi_a2x_2_A2X_AR_FIFO_DEPTH 4
...
`define i_axi_a2x_2_A2X_RD_FIFO_DEPTH 16
...
`define i_axi_a2x_2_A2X_LK_RD_FIFO_DEPTH 4
...
// set to 1. 
// 
`define i_axi_a2x_2_A2X_AUTO_LINK_SPLIT_MODE 1
...
`define i_axi_a2x_2_A2X_AR_SP_PIPELINE 0
...
`define i_axi_a2x_2_A2X_AW_SP_PIPELINE 0


`define i_axi_a2x_2_A2X_RS_AR_TMO 0


`define i_axi_a2x_2_A2X_RS_AW_TMO 0


`define i_axi_a2x_2_A2X_RS_R_TMO 0


`define i_axi_a2x_2_A2X_RS_W_TMO 0


`define i_axi_a2x_2_A2X_RS_B_TMO 0

//**************************************************************************************************
// Defined Constants (Resized configurations)
//**************************************************************************************************

`define i_axi_a2x_2_A2X_AHB_LOCKED 0


// `define i_axi_a2x_2_A2X_HAS_LOCKED


`define i_axi_a2x_2_A2X_INT_NUM_AHBM 9


`define i_axi_a2x_2_A2X_UPSIZE 0


`define i_axi_a2x_2_A2X_DOWNSIZE 0


// `define i_axi_a2x_2_A2X_IS_UPSIZED

// `define i_axi_a2x_2_A2X_IS_DOWNSIZED


// `define i_axi_a2x_2_A2X_HAS_RBUF


`define i_axi_a2x_2_A2X_IS_EQSIZED

//**************************************************************************************************
// Defined Constants (INCR Enables)
//**************************************************************************************************

`define i_axi_a2x_2_A2X_HAS_NBUF_MODE


`define i_axi_a2x_2_A2X_HAS_HINCR_HCBCNT


`define i_axi_a2x_2_A2X_HAS_SINGLE_RBCNT


`define i_axi_a2x_2_A2X_HAS_SINGLE_WBCNT


// `define i_axi_a2x_2_A2X_HAS_CNT_M1


// `define i_axi_a2x_2_A2X_HAS_CNT_M2


// `define i_axi_a2x_2_A2X_HAS_CNT_M3


// `define i_axi_a2x_2_A2X_HAS_CNT_M4


// `define i_axi_a2x_2_A2X_HAS_CNT_M5


// `define i_axi_a2x_2_A2X_HAS_CNT_M6


// `define i_axi_a2x_2_A2X_HAS_CNT_M7


`define i_axi_a2x_2_A2X_HAS_CNT_M8


// `define i_axi_a2x_2_A2X_HAS_CNT_M9


// `define i_axi_a2x_2_A2X_HAS_CNT_M10


// `define i_axi_a2x_2_A2X_HAS_CNT_M11


// `define i_axi_a2x_2_A2X_HAS_CNT_M12


// `define i_axi_a2x_2_A2X_HAS_CNT_M13


// `define i_axi_a2x_2_A2X_HAS_CNT_M14


// `define i_axi_a2x_2_A2X_HAS_CNT_M15
...
// `define i_axi_a2x_2_A2X_HAS_LOWPWR_IF


// `define i_axi_a2x_2_A2X_HAS_USER_SIGNAL_XFER_MODE

`define i_axi_a2x_2_A2X_INT_HASBW 1

// `define i_axi_a2x_2_A2X_HAS_HASB

`define i_axi_a2x_2_A2X_INT_HWSBW 1

// `define i_axi_a2x_2_A2X_HAS_HWSB

`define i_axi_a2x_2_A2X_INT_HRSBW 1

// `define i_axi_a2x_2_A2X_HAS_HRSB


// `define i_axi_a2x_2_A2X_HAS_AWSB

`define i_axi_a2x_2_A2X_INT_AWSBW 1

// `define i_axi_a2x_2_A2X_HAS_WSB

`define i_axi_a2x_2_A2X_INT_WSBW 1

// `define i_axi_a2x_2_A2X_HAS_ARSB

`define i_axi_a2x_2_A2X_INT_ARSBW 1

// `define i_axi_a2x_2_A2X_HAS_RSB

`define i_axi_a2x_2_A2X_INT_RSBW 1

// `define i_axi_a2x_2_A2X_HAS_BSB

`define i_axi_a2x_2_A2X_INT_BSBW 1

// `define i_axi_a2x_2_A2X_PP_IS_AHB

`define i_axi_a2x_2_A2X_PP_IS_AXI

`define i_axi_a2x_2_A2X_CLK_IS_SYNC

//**************************************************************************************************
// Defined Constants (FIFO Parameter)
//**************************************************************************************************

`define i_axi_a2x_2_A2X_AW_FIFO_DEPTH_LOG2 2

`define i_axi_a2x_2_A2X_AR_FIFO_DEPTH_LOG2 2

`define i_axi_a2x_2_A2X_BRESP_FIFO_DEPTH_LOG2 1

`define i_axi_a2x_2_A2X_WD_FIFO_DEPTH_LOG2 4

`define i_axi_a2x_2_A2X_RD_FIFO_DEPTH_LOG2 4

`define i_axi_a2x_2_A2X_B_OSW_LIMIT_LOG2 1

`define i_axi_a2x_2_A2X_PP_OSAW_LIMIT_LOG2 1

`define i_axi_a2x_2_A2X_SP_OSAW_LIMIT_LOG2 1

`define i_axi_a2x_2_A2X_OSR_LIMIT_LOG2 1

`define i_axi_a2x_2_A2X_LK_RD_FIFO_DEPTH_LOG2 2
//**************************************************************************************************
// Defined Constants (DW_axi_a2x Parameter)
//**************************************************************************************************

`define i_axi_a2x_2_A2X_PP_DW_LOG2 6

`define i_axi_a2x_2_A2X_SP_DW_LOG2 6

`define i_axi_a2x_2_A2X_PP_NUM_BYTES 8

`define i_axi_a2x_2_A2X_PP_WSTRB_DW 8

`define i_axi_a2x_2_A2X_SP_NUM_BYTES 8

`define i_axi_a2x_2_A2X_SP_WSTRB_DW 8

`define i_axi_a2x_2_A2X_PP_MAX_SIZE 3

`define i_axi_a2x_2_A2X_SP_MAX_SIZE 3

`define i_axi_a2x_2_A2X_MAX_PP_TOTAL_BYTES 2056

`define i_axi_a2x_2_A2X_MAX_SP_TOTAL_BYTES 2056

`define i_axi_a2x_2_A2X_MAX_TOTAL_BYTES 2056


`define i_axi_a2x_2_A2X_MAX_TOTAL_BYTES_LOG2 12

`define i_axi_a2x_2_A2X_PP_NUM_BYTES_LOG2 3

`define i_axi_a2x_2_A2X_SP_NUM_BYTES_LOG2 3


`define i_axi_a2x_2_A2X_PP_DW_16


`define i_axi_a2x_2_A2X_PP_DW_32


`define i_axi_a2x_2_A2X_PP_DW_64


// `define i_axi_a2x_2_A2X_PP_DW_128


// `define i_axi_a2x_2_A2X_PP_DW_256


// `define i_axi_a2x_2_A2X_PP_DW_512


// `define i_axi_a2x_2_A2X_PP_DW_1024


`define i_axi_a2x_2_A2X_SP_DW_32


`define i_axi_a2x_2_A2X_SP_DW_64


// `define i_axi_a2x_2_A2X_SP_DW_128


// `define i_axi_a2x_2_A2X_SP_DW_256


// `define i_axi_a2x_2_A2X_SP_DW_512


// `define i_axi_a2x_2_A2X_SP_DW_1024


// `define i_axi_a2x_2_A2X_DS_RATIO_2


// `define i_axi_a2x_2_A2X_DS_RATIO_4


// `define i_axi_a2x_2_A2X_DS_RATIO_8
...
`define i_axi_a2x_2_DWC_NO_TST_MODE

`define i_axi_a2x_2_DWC_NO_CDC_INIT
...
`define i_axi_a2x_2_A2X_SIM_SEED 200


`define i_axi_a2x_2_A2X_SIM_APB_CLK_PERIOD 20


`define i_axi_a2x_2_A2X_SIM_PP_CLK_PERIOD 10


`define i_axi_a2x_2_A2X_SIM_SP_CLK_PERIOD 10


`define i_axi_a2x_2_A2X_SP_CLK_SKEW 0


`define i_axi_a2x_2_A2X_INACTIVE_VAL 0


// `define i_axi_a2x_2_A2X_ASYNC_CLKS


// `define i_axi_a2x_2_A2X_DUAL_CLK

//The following is a way to duplicate the testcases

`define i_axi_a2x_2_A2X_N_TESTCASE_DUPLICATION 0
...
`define i_axi_a2x_2_A2X_PRIMEPOWER_SIM 0


// `define i_axi_a2x_2_A2X_SIM_IS_PRIMEPOWER


`define i_axi_a2x_2_A2X_VERIF_EN 1


`define i_axi_a2x_2_A2X_HRESPW 2

`define i_axi_a2x_2_A2X_HRESP_WIDTH_2
