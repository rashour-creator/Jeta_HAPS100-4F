...
`include "/slowfs/de06-cae-scratch/work/reem/jeta_capim_new_SNPS_fabric/rtl/SNPS_fabric/components/i_axi_a2x_2/DW_axi_a2x_all_includes.vh"

module i_axi_a2x_2_DW_axi_a2x (
...
// spyglass enable_block Topology_02
  ...
  parameter A2X_PP_OSAW_LIMIT = 2;
  parameter A2X_PP_OSAW_LIMIT_LOG2 = 1;

  parameter A2X_B_OSW_LIMIT = 2;
  parameter A2X_B_OSW_LIMIT_LOG2 = 1;

  parameter A2X_OSR_LIMIT = 2;
  parameter A2X_OSR_LIMIT_LOG2 = 1;
  ...
  parameter A2X_SP_DWIDTH = 64;
  parameter A2X_SP_MAX_SIZE = 3;
  parameter A2X_SP_WSTRB_DW = 8;
  parameter A2X_SP_NUM_BYTES = 8;
  parameter A2X_SP_NUM_BYTES_LOG2 = 3;
  ...
  input  [`i_axi_a2x_2_A2X_INT_LTW-1:0]                   awlock_pp;
  ...
  input  [`i_axi_a2x_2_A2X_INT_LTW-1:0]                   arlock_pp;
  ...
  output                                      bready_sp;
  input                                       bvalid_sp;
  input [`i_axi_a2x_2_A2X_SP_IDW-1:0]                     bid_sp;
  ...
  input                                       rvalid_sp;
  input                                       rlast_sp;
  input [`i_axi_a2x_2_A2X_SP_IDW-1:0]                     rid_sp;
  ...
  wire                                        hresetn        = 1'b1;
  wire                                        hsel           = 1'b0;
  wire   [`i_axi_a2x_2_A2X_IDW-1:0]                       hmaster        = {`i_axi_a2x_2_A2X_IDW{1'b0}};
  wire   [A2X_PP_AWIDTH-1:0]                  haddr          = {A2X_PP_AWIDTH{1'b0}};
  wire                                        hwrite         = 1'b0;
  wire                                        hmastlock      = 1'b0;
  wire   [`i_axi_a2x_2_A2X_HBLW-1:0]                      hburst         = {`i_axi_a2x_2_A2X_HBLW{1'b0}};
  wire                                        hresize        = 1'b0;
  wire   [1:0]                                htrans         = 2'b00;
  wire   [`i_axi_a2x_2_A2X_BSW-1:0]                       hsize          = {`i_axi_a2x_2_A2X_BSW{1'b0}};
  wire   [`i_axi_a2x_2_A2X_HPTW-1:0]                      hprot          = {`i_axi_a2x_2_A2X_HPTW{1'b0}};
  wire   [A2X_PP_DWIDTH-1:0]                  hwdata         = {A2X_PP_DWIDTH{1'b0}};

  wire                                        hready         = 1'b1;
  wire                                        hready_resp;
  wire   [`i_axi_a2x_2_A2X_HRESPW-1:0]                    hresp;
  ...
  //-----------------------------AXI Interface------------------------------------------
    wire   [`i_axi_a2x_2_A2X_IDW-1:0]                     wid_pp              ={`i_axi_a2x_2_A2X_IDW{1'b0}};
    wire   [`i_axi_a2x_2_A2X_SP_IDW-1:0]                  wid_sp;
    wire   [`i_axi_a2x_2_A2X_LTW-1:0]                     awlock_core_pp      ={1'b0,awlock_pp};
    wire   [`i_axi_a2x_2_A2X_LTW-1:0]                     arlock_core_pp      ={1'b0,arlock_pp};
  ...
  wire                                        cactive; 
  wire                                        busy_status;
  wire    [`i_axi_a2x_2_A2X_INT_LTW-1:0]                  awlock_core_sp;
  wire    [`i_axi_a2x_2_A2X_INT_LTW-1:0]                  arlock_core_sp;
  ...
  //*************************************************************************************
   i_axi_a2x_2_DW_axi_a2x_core
    #(
     ...
     .bvalid_sp                               (bvalid_sp),
     .bready_sp                               (bready_sp),
     .bid_sp                                  (bid_sp[`i_axi_a2x_2_A2X_IDW-1:0]),
     .bresp_sp                                (bresp_sp),
     ...
     .rready_sp                               (rready_sp),
     .rlast_sp                                (rlast_sp),
     .rid_sp                                  (rid_sp[`i_axi_a2x_2_A2X_IDW-1:0]),
     .rdata_sp                                (rdata_sp),
