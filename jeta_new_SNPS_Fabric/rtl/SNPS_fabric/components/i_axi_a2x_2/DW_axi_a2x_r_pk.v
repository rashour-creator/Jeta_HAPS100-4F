...
//
//*********************************************************
module i_axi_a2x_2_DW_axi_a2x_r_pk (/*AUTOARG*/
   // Outputs
  ...
  // Signal Decelaration
  //********************************************************* 
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                   rid_i;    
  wire  [A2X_SP_DW-1:0]                  rdata_i; 
  wire  [`i_axi_a2x_2_A2X_RRESPW-1:0]                rresp_i; 
  ...
  wire   [`i_axi_a2x_2_A2X_BSW-1:0]                  sp_size;
  wire                                   subsized;
  wire                                   shift_lsb;
  ...
  reg    [`i_axi_a2x_2_A2X_RRESPW-1:0]               rresp_r; 
  wire   [`i_axi_a2x_2_A2X_RRESPW-1:0]               rresp_w; 
 ...
 // assign pp_size_1hot[A2X_PP_MAX_SIZE:0] = pp_size_1hot_r[A2X_PP_MAX_SIZE:0];
  ...
  generate
    ...
    for (i = 0; i <A2X_PP_NUM_BYTES; i = i + 1) begin : pk_byte
      ...
      i_axi_a2x_2_DW_axi_a2x_r_pk_byte
  ...
  always @(posedge clk or negedge resetn) begin: rresp_PROC
    if (resetn==1'b0) begin
      rresp_r <= {`i_axi_a2x_2_A2X_RRESPW{1'b0}};
    end else begin
