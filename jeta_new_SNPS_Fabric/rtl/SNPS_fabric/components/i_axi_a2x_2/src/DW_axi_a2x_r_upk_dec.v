...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/axi_dev_br/src/DW_axi_a2x_r_upk_dec.v#6 $ 
// --------------------------------------------------------------------
*/
...
// 3 -> [15:0] & [31:16] Valid
//*********************************************************
module i_axi_a2x_2_DW_axi_a2x_r_upk_dec (/*AUTOARG*/
   // Outputs
   r_pyld_tag, 
   // Inputs
  ...
  wire   [`i_axi_a2x_2_A2X_BSW-1:0]                  asize_pp;     
  wire                                   wrap_last;
  wire                                   arlast;
  wire                                   fixed;
  wire                                   fixed_i;
