...
module i_axi_a2x_2_DW_axi_a2x_h2x (/*AUTOARG*/
   // Outputs
  ...
  wire  [1:0]                                 htrans_dp;
  wire                                        hwrite_dp;
  wire  [`i_axi_a2x_2_A2X_HBLW-1:0]                       hburst_dp;            
  ...
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                        hmaster_dp;      // AHB Master ID Bus
  // These are dummy wires used to connect the unconnected ports.
  // Hence will not drive any nets.
  wire                                        hmastlock_dp;
  ...
  //*************************************************************************************
  i_axi_a2x_2_DW_axi_a2x_h2x_decode
   #(
  ...
  // Read Control. 
  //*************************************************************************************
  i_axi_a2x_2_DW_axi_a2x_h2x_resp
   #(
      .A2X_NUM_AHBM                       (A2X_NUM_AHBM)
     ,.A2X_SPLIT_MODE                     (A2X_SPLIT_MODE) 
  ) U_h2x_resp (
