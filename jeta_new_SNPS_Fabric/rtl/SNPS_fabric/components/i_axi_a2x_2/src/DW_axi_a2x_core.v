...
module i_axi_a2x_2_DW_axi_a2x_core (/*AUTOARG*/
   // Outputs
  ...
  // set to zero.
  localparam A2X_INT_HASBW                  = (`i_axi_a2x_2_A2X_A_UBW==0)? 1 : `i_axi_a2x_2_A2X_A_UBW;   
  ...
  localparam A2X_INT_HWSBW                  = (`i_axi_a2x_2_A2X_W_UBW==0)? 1 : `i_axi_a2x_2_A2X_W_UBW;
  localparam A2X_INT_WSBW                   = (A2X_WSBW==0)?  1  : A2X_WSBW;
  localparam A2X_INT_PPWSBW                 = (A2X_PP_MODE==0)? A2X_INT_HWSBW : A2X_INT_WSBW; 
  localparam A2X_INT_HRSBW                  = (`i_axi_a2x_2_A2X_R_UBW==0)? 1 : `i_axi_a2x_2_A2X_R_UBW;
  ...
  // Bresp Payload
  localparam A2X_B_PYLD_W                   = A2X_INT_BSBW + `i_axi_a2x_2_A2X_IDW + `i_axi_a2x_2_A2X_BRESPW;

  // AW payload in AXI
  localparam A2X_AW_PYLD_W                  = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +`i_axi_a2x_2_A2X_HBTYPE_W  +
                                              A2X_INT_AWSBW + `i_axi_a2x_2_A2X_IDW + A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + 
                                              `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  // AW payload in AHB
  localparam A2X_AW_PYLD_W_AHB              = `i_axi_a2x_2_A2X_HBTYPE_W + A2X_INT_AWSBW + `i_axi_a2x_2_A2X_IDW + A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + 
                                              `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  // AR Payload in AXI                                     
  localparam A2X_AR_PYLD_W                  = A2X_BARW + A2X_RSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW + `i_axi_a2x_2_A2X_HBTYPE_W +
                                              A2X_INT_ARSBW + `i_axi_a2x_2_A2X_IDW + A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + 
                                              `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  // AR Payload in AHB                                     
  localparam A2X_AR_PYLD_W_AHB              = `i_axi_a2x_2_A2X_HBTYPE_W + A2X_INT_ARSBW + `i_axi_a2x_2_A2X_IDW + A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + 
                                              `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
 // Primary & Secondary Port W Payload
  localparam A2X_W_PP_PYLD_W                = A2X_INT_PPWSBW + `i_axi_a2x_2_A2X_IDW + A2X_PP_DW + A2X_PP_WSTRB_DW + 1;
  localparam A2X_W_SP_PYLD_W                = A2X_INT_WSBW + `i_axi_a2x_2_A2X_IDW + A2X_SP_DW + A2X_SP_WSTRB_DW + 1;

  // Primary & Secondary Port R Payload
  localparam A2X_R_PP_PYLD_W                = A2X_INT_PPRSBW + `i_axi_a2x_2_A2X_IDW + A2X_PP_DW + `i_axi_a2x_2_A2X_RRESPW + 1;
  localparam A2X_R_SP_PYLD_W                = A2X_INT_RSBW + `i_axi_a2x_2_A2X_IDW + A2X_SP_DW + `i_axi_a2x_2_A2X_RRESPW + 1;
  ...
  localparam A2X_SP_OSAW_PYLD_W            = `i_axi_a2x_2_A2X_RSW + 1 + `i_axi_a2x_2_A2X_BSW + W_PP_NUM_BYTES_LOG2 + 1 + A2X_BLW + 1; 
  ...
  localparam A2X_RDS_PYLD_W                 = `i_axi_a2x_2_A2X_RSW + 1 + `i_axi_a2x_2_A2X_BSW + PP_NUM_BYTES_LOG2 + 1;                                            

  localparam A2X_RUS_PYLD_W                 = `i_axi_a2x_2_A2X_RSW + 1 + BLW_PP + `i_axi_a2x_2_A2X_BSW + 1 + A2X_SP_NUM_BYTES_LOG2;
  ...
  // ID From-To Bits
  localparam AWID_FROM_BIT                  = `i_axi_a2x_2_A2X_IDW + A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  localparam AWID_TO_BIT                    =  A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;

  localparam ARID_FROM_BIT                  = `i_axi_a2x_2_A2X_IDW + A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  localparam ARID_TO_BIT                    = A2X_AW  + `i_axi_a2x_2_A2X_RSW + A2X_BLW + `i_axi_a2x_2_A2X_BSW + `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  
  localparam ARLEN_FROM_BIT                 =  A2X_BLW + `i_axi_a2x_2_A2X_BSW + `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  localparam ARLEN_TO_BIT                   =  `i_axi_a2x_2_A2X_BSW + `i_axi_a2x_2_A2X_BTW + `i_axi_a2x_2_A2X_LTW + `i_axi_a2x_2_A2X_CTW + `i_axi_a2x_2_A2X_PTW;
  ...
  input  [`i_axi_a2x_2_A2X_IDW-1:0]                       hmaster;     // AHB Master ID Bus
  input  [A2X_AW-1:0]                         haddr;       // AHB Address Bus
  input                                       hwrite;      // AHB write indicator   
  input                                       hmastlock;   // AHB lock              
  input  [`i_axi_a2x_2_A2X_HBLW-1:0]                      hburst;      // AHB burst             
  input                                       hresize;     // AHB Resize Data
  input  [1:0]                                htrans;      // AHB address phase     
  input  [`i_axi_a2x_2_A2X_BSW-1:0]                       hsize;       // AHB size              
  input  [`i_axi_a2x_2_A2X_HPTW-1:0]                      hprot;       // AHB protection        
  input  [A2X_PP_DW-1:0]                      hwdata;      // AHB write data        

  input                                       hready;      // AHB ready
  output                                      hready_resp; // AHB ready                 
  output [`i_axi_a2x_2_A2X_HRESPW-1:0]                    hresp;       // AHB response              
  ...
  output                                      awready_pp; 
  input                                       awvalid_pp;
  input  [`i_axi_a2x_2_A2X_IDW-1:0]                       awid_pp;    
  input  [A2X_AW-1:0]                         awaddr_pp; 
  input  [A2X_BLW-1:0]                        awlen_pp; 
  input  [`i_axi_a2x_2_A2X_BSW-1:0]                       awsize_pp;     
  input  [`i_axi_a2x_2_A2X_BTW-1:0]                       awburst_pp;   
  input  [`i_axi_a2x_2_A2X_CTW-1:0]                       awcache_pp; 
  input  [`i_axi_a2x_2_A2X_PTW-1:0]                       awprot_pp; 
  input                                       awresize_pp;
  ...
  input  [`i_axi_a2x_2_A2X_LTW-1:0]                       awlock_pp;   

  // AXI write data
  output                                      wready_pp;    
  input                                       wvalid_pp;   
  input                                       wlast_pp;   
  input  [`i_axi_a2x_2_A2X_IDW-1:0]                       wid_pp;    
  ...
  input                                       bready_pp; 
  output                                      bvalid_pp;     
  output [`i_axi_a2x_2_A2X_IDW-1:0]                       bid_pp;       
  output [`i_axi_a2x_2_A2X_BRESPW-1:0]                    bresp_pp;    
  ...
  output                                      arready_pp; 
  input                                       arvalid_pp;
  input  [`i_axi_a2x_2_A2X_IDW-1:0]                       arid_pp;    
  input  [A2X_AW-1:0]                         araddr_pp; 
  input  [A2X_BLW-1:0]                        arlen_pp; 
  input  [`i_axi_a2x_2_A2X_BSW-1:0]                       arsize_pp;     
  input  [`i_axi_a2x_2_A2X_BTW-1:0]                       arburst_pp;   
  input  [`i_axi_a2x_2_A2X_CTW-1:0]                       arcache_pp; 
  input  [`i_axi_a2x_2_A2X_PTW-1:0]                       arprot_pp; 
  input                                       arresize_pp;
  ...
  input  [`i_axi_a2x_2_A2X_LTW-1:0]                       arlock_pp;   
  
  // AXI Read data
  input                                       rready_pp;    
  output                                      rvalid_pp;   
  output                                      rlast_pp;   
  output [`i_axi_a2x_2_A2X_IDW-1:0]                       rid_pp;    
  output [A2X_PP_DW-1:0]                      rdata_pp; 
  output [`i_axi_a2x_2_A2X_RRESPW-1:0]                    rresp_pp; 
  ...
  input                                       awready_sp; 
  output                                      awvalid_sp;
  output [`i_axi_a2x_2_A2X_SP_IDW-1:0]                    awid_sp;    
  output [A2X_SP_AW-1:0]                      awaddr_sp; 
  output [A2X_SP_BLW-1:0]                     awlen_sp; 
  output [`i_axi_a2x_2_A2X_BSW-1:0]                       awsize_sp;     
  output [`i_axi_a2x_2_A2X_BTW-1:0]                       awburst_sp;   
  output [`i_axi_a2x_2_A2X_INT_LTW-1:0]                   awlock_sp;   
  output [`i_axi_a2x_2_A2X_CTW-1:0]                       awcache_sp; 
  output [`i_axi_a2x_2_A2X_PTW-1:0]                       awprot_sp; 
  ...
  output                                      wvalid_sp;   
  output                                      wlast_sp;   
  output [`i_axi_a2x_2_A2X_SP_IDW-1:0]                    wid_sp;    
  ...
  output                                      bready_sp;
  input                                       bvalid_sp;     
  input [`i_axi_a2x_2_A2X_IDW-1:0]                        bid_sp;       
  input [`i_axi_a2x_2_A2X_BRESPW-1:0]                     bresp_sp;    
  input [A2X_INT_BSBW-1:0]                    bsideband_sp; 
  input [A2X_INT_BSBW-1:0]                    buser_sp;  
  // AXI Read Address
  input                                       arready_sp; 
  output                                      arvalid_sp;
  output [`i_axi_a2x_2_A2X_SP_IDW-1:0]                    arid_sp;    
  output [A2X_SP_AW-1:0]                      araddr_sp; 
  output [A2X_SP_BLW-1:0]                     arlen_sp; 
  output [`i_axi_a2x_2_A2X_BSW-1:0]                       arsize_sp;     
  output [`i_axi_a2x_2_A2X_BTW-1:0]                       arburst_sp;   
  output [`i_axi_a2x_2_A2X_INT_LTW-1:0]                   arlock_sp;   
  output [`i_axi_a2x_2_A2X_CTW-1:0]                       arcache_sp; 
  output [`i_axi_a2x_2_A2X_PTW-1:0]                       arprot_sp; 
  ...
  input                                       rvalid_sp;   
  input                                       rlast_sp;   
  input [`i_axi_a2x_2_A2X_IDW-1:0]                        rid_sp;    
  input [A2X_SP_DW-1:0]                       rdata_sp; 
  input [`i_axi_a2x_2_A2X_RRESPW-1:0]                     rresp_sp; 
  ...
  // Signal Decelaration
  //*************************************************************************************
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                        awid_sp_w;
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                        arid_sp_w;
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                        wid_sp_w;
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                        bid_sp_w;
  wire  [`i_axi_a2x_2_A2X_IDW-1:0]                        rid_sp_w;
  ...
  wire                                        aw_last_sp;
  wire                                        aw_nbuf_sp; 
  wire   [`i_axi_a2x_2_A2X_IDW-1:0]                       aw_id_sp;   
  wire   [`i_axi_a2x_2_A2X_IDW-1:0]                       ar_id_sp;   
  ...
  wire                                        wlast_pp_w;
  wire [`i_axi_a2x_2_A2X_IDW-1:0]                         wid_pp_w;    
  ...
  wire  [`i_axi_a2x_2_A2X_LTW-1:0]                        awlock_core_sp;
  wire  [`i_axi_a2x_2_A2X_LTW-1:0]                        arlock_core_sp;
  ...
  //*************************************************************************************
  generate 
  if (`i_axi_a2x_2_A2X_IDW==`i_axi_a2x_2_A2X_SP_IDW) begin: IDW
    ...
    assign awid_sp   = {{(`i_axi_a2x_2_A2X_SP_IDW-`i_axi_a2x_2_A2X_IDW){1'b0}}, awid_sp_w};
    assign arid_sp   = {{(`i_axi_a2x_2_A2X_SP_IDW-`i_axi_a2x_2_A2X_IDW){1'b0}}, arid_sp_w};
    assign wid_sp    = {{(`i_axi_a2x_2_A2X_SP_IDW-`i_axi_a2x_2_A2X_IDW){1'b0}}, wid_sp_w};
    assign bid_sp_w  = bid_sp[`i_axi_a2x_2_A2X_IDW-1:0];
    assign rid_sp_w  = rid_sp[`i_axi_a2x_2_A2X_IDW-1:0];
  end
  endgenerate
  ...
  generate
    if(A2X_LOWPWR_IF==1) begin: BUSY_STATUS
      ...
      i_axi_a2x_2_DW_axi_a2x_busy_osx
  ...
  generate 
    if (A2X_PP_MODE==0) begin: H2X
      ...
      assign hresp        = {`i_axi_a2x_2_A2X_HRESPW{1'b0}};
  ...
  assign wid_pp_w   = w_pyld_pp[A2X_W_PP_PYLD_W-A2X_INT_PPWSBW-1:A2X_W_PP_PYLD_W-A2X_INT_PPWSBW-`i_axi_a2x_2_A2X_IDW];

  //*************************************************************************************
  // Write Path Instantiation
  //*************************************************************************************
  i_axi_a2x_2_DW_axi_a2x_w
   #(
      .A2X_PP_MODE                          (A2X_PP_MODE)
     ,.A2X_UPSIZE                           (A2X_UPSIZE)
     ,.A2X_DOWNSIZE                         (A2X_DOWNSIZE)
