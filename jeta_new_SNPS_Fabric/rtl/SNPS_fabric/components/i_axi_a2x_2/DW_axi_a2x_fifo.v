...
module i_axi_a2x_2_DW_axi_a2x_fifo (
  // Inputs - Push Side 
  clk_push_i,
  resetn_push_i,
  ...
  //--------------------------------------------------------------------
    ...
    if (DUAL_CLK==0) begin: SCLK_FIFO
      ...
      if (REG_OUT==1) begin: SCLK_REG_OUT
        ...
        i_axi_a2x_2_DW_axi_a2x_fifo_sclk_r
         #(
...
// This instance design is shared by other module(s) that uses these port(s).
      i_axi_a2x_2_DW_axi_a2x_bcm66
       ...
       .RST_MODE           (0),                // Reset mode, asynch. reset including memory.
       .VERIF_EN           (`i_axi_a2x_2_A2X_VERIF_EN),    // Verification control enable 
       .MEM_MODE           (1),                // Mem mode
