...
module i_axi_a2x_DW_axi_a2x_sp_add (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_A_PYLD_W             = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +
                                        `i_axi_a2x_A2X_HBTYPE_W +  A2X_ASBW  + `i_axi_a2x_A2X_IDW +  A2X_AW   + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
  ...
  localparam A2X_RS_PYLD_W            = (A2X_UPSIZE==1)?  (`i_axi_a2x_A2X_RSW + `i_axi_a2x_A2X_BSW + A2X_SP_NUM_BYTES_LOG2) : 
                                                          (`i_axi_a2x_A2X_RSW + `i_axi_a2x_A2X_BSW + A2X_PP_NUM_BYTES_LOG2);

  // Address Splitter fanns out alen
  localparam A2X_AS_PYLD_W            = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +
                                        `i_axi_a2x_A2X_HBTYPE_W + A2X_ASBW + `i_axi_a2x_A2X_IDW +  A2X_AW  + `i_axi_a2x_A2X_RSW + BLW_AS + `i_axi_a2x_A2X_BSW + 
                                        `i_axi_a2x_A2X_BTW      + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;

  // Address Resizer fanns out alen 
  localparam A2X_AR_PYLD_W            = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +
                                        `i_axi_a2x_A2X_HBTYPE_W + A2X_ASBW + `i_axi_a2x_A2X_IDW +  A2X_AW  + `i_axi_a2x_A2X_RSW + BLW_RS + `i_axi_a2x_A2X_BSW + 
                                        `i_axi_a2x_A2X_BTW      + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;

  // Used For Bypassing Address Calculator                                      
  localparam ALEN_PYLD_TO_BIT         = `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW      + `i_axi_a2x_A2X_LTW   + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  localparam ALEN_PYLD_FROM_BIT       =  BLW_RS  + ALEN_PYLD_TO_BIT;

  // Used for Lock Transaction
  localparam ALOCK_PYLD_TO_BIT        =  `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  localparam ALOCK_PYLD_FROM_BIT      =  `i_axi_a2x_A2X_LTW + ALOCK_PYLD_TO_BIT;
  ...
  output [`i_axi_a2x_A2X_BSW-1:0]                       ws_size; 
  output [`i_axi_a2x_A2X_RSW-1:0]                       ws_resize; 
  output                                      ws_fixed;
  output                                      ws_last;
  output                                      w_snf_pop_en;
  ...
  wire   [`i_axi_a2x_A2X_IDW-1:0]                       aid_i;             // Payload
  wire   [A2X_AW-1:0]                         aaddr_i; 
  wire   [A2X_BLW-1:0]                        alen_i; 
  wire   [`i_axi_a2x_A2X_BTW-1:0]                       aburst_i;   
  wire   [`i_axi_a2x_A2X_CTW-1:0]                       acache_i; 
  wire   [`i_axi_a2x_A2X_PTW-1:0]                       aprot_i; 
  ...
  wire   [`i_axi_a2x_A2X_RSW-1:0]                       aresize_i;
  wire                                        hburst_type; 
  ...
  wire   [`i_axi_a2x_A2X_BSW-1:0]                       asize_i;     
  wire   [`i_axi_a2x_A2X_LTW-1:0]                       alock_i;   

  // Generated from Locked Control
  wire   [`i_axi_a2x_A2X_LTW-1:0]                       alock_o;   
  ...
  generate
    if ( (A2X_LOCKED==1) && ((A2X_PP_MODE==0) || (A2X_LOCKED==1) || (A2X_UPSIZE==1) || (A2X_DOWNSIZE==1) || (A2X_BRESP_MODE==0))) begin: LK
      i_axi_a2x_DW_axi_a2x_sp_add_lk
       #(
  ...
  if (BYPASS_AS==0) begin: ASBLK
    i_axi_a2x_DW_axi_a2x_sp_add_split
     #(
       .A2X_CHANNEL        (A2X_CHANNEL) 
      ,.A2X_PP_MODE        (A2X_PP_MODE) 
      ,.A2X_AW             (A2X_AW)
    ...
    assign snf_pyld_w = (buf_mode==`i_axi_a2x_SNF_MODE)? snf_pyld_i : 0; 
    ...
    assign ws_resize   = {`i_axi_a2x_A2X_RSW{1'b0}};
  ...
  generate
    if ((A2X_UPSIZE==1) || (A2X_DOWNSIZE==1)) begin: RS_BLK
      i_axi_a2x_DW_axi_a2x_sp_add_rs
       #(
         .A2X_PP_MODE           (A2X_PP_MODE)
        ,.A2X_CHANNEL           (A2X_CHANNEL) 
        ,.A2X_BLW               (A2X_BLW)
  ...
  generate 
    if (BYPASS_AC==0) begin: AC_BLK
      i_axi_a2x_DW_axi_a2x_sp_add_calc
       #(
         .A2X_CHANNEL        (A2X_CHANNEL) 
        ,.A2X_PP_MODE        (A2X_PP_MODE) 
        ,.A2X_DOWNSIZE       (A2X_DOWNSIZE)
