...
//*************************************************************************************
module i_axi_a2x_DW_axi_a2x_h2x_resp (/*AUTOARG*/
   // Outputs
  ...
  output [15:0]                  hsplit;
  output                         hready_resp;
  output [`i_axi_a2x_A2X_HRESPW-1:0]       hresp; 
  ...
  wire                           hready_w;
  reg                            hready_resp;
  reg    [`i_axi_a2x_A2X_HRESPW-1:0]       hresp;
  reg    [`i_axi_a2x_A2X_HRESPW-1:0]       hresp_w;
