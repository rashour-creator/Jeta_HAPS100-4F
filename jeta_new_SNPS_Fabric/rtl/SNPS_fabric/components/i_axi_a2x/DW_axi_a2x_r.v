...
module i_axi_a2x_DW_axi_a2x_r (/*AUTOARG*/
  ...
  localparam A2X_RUS_PYLD_W              = `i_axi_a2x_A2X_RSW + 1 + BLW_PP + `i_axi_a2x_A2X_BSW + A2X_SP_NUM_BYTES_LOG2 + 1;
  ...
  i_axi_a2x_DW_axi_a2x_fifo
   #(
    ...
    ,.PUSH_SYNC_DEPTH                        (`i_axi_a2x_A2X_SP_SYNC_DEPTH)
    ,.POP_SYNC_DEPTH                         (`i_axi_a2x_A2X_PP_SYNC_DEPTH)
