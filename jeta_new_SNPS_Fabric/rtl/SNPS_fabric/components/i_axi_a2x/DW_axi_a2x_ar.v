...
module i_axi_a2x_DW_axi_a2x_ar (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_AR_PYLD_W            = A2X_BARW + A2X_RSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW + `i_axi_a2x_A2X_HBTYPE_W + 
                                        A2X_ARSBW + `i_axi_a2x_A2X_IDW +  A2X_AW   + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
  ...
  localparam A2X_RDS_PYLD_W            = `i_axi_a2x_A2X_RSW + 1 + `i_axi_a2x_A2X_BSW + A2X_PP_NUM_BYTES_LOG2 + 1; 
  ...
  wire   [`i_axi_a2x_A2X_IDW-1:0]                       aid_i;             // FIFO Payload
