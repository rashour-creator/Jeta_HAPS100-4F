...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/axi_dev_br/src/DW_axi_a2x_b_buf.v#7 $ 
**
** --------------------------------------------------------------------
*/
//*************************************************************************************
...
module i_axi_a2x_DW_axi_a2x_b_buf (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_IDW                         = `i_axi_a2x_A2X_IDW;
  localparam A2X_BRESPW                      = `i_axi_a2x_A2X_BRESPW;
  ...
  //*************************************************************************************
  // Return OK Response
  assign bresp_o     = `i_axi_a2x_AOKAY;
  // Return Write ID 
