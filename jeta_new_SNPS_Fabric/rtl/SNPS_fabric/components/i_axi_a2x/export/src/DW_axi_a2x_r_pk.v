...
module i_axi_a2x_DW_axi_a2x_r_pk (/*AUTOARG*/
  ...
  wire   [`i_axi_a2x_A2X_BSW-1:0]                  pp_size;     
  wire                                   resize;
  wire                                   ws_last;
  wire                                   ws_fixed; 

  wire   [A2X_PP_NUM_BYTES_LOG2-1:0]     addr_i;
  wire   [`i_axi_a2x_A2X_BSW-1:0]                  sp_size;
  wire                                   subsized;
  wire                                   shift_lsb;
  ...
  reg    [`i_axi_a2x_A2X_RRESPW-1:0]               rresp_r; 
  wire   [`i_axi_a2x_A2X_RRESPW-1:0]               rresp_w; 
 ...
 // assign pp_size_1hot[A2X_PP_MAX_SIZE:0] = pp_size_1hot_r[A2X_PP_MAX_SIZE:0];
  ...
  always @(posedge clk or negedge resetn) begin: rresp_PROC
    if (resetn==1'b0) begin
      rresp_r <= {`i_axi_a2x_A2X_RRESPW{1'b0}};
    end else begin
