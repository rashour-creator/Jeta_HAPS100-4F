...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/axi_dev_br/src/DW_axi_a2x_aw.v#10 $ 
**
** --------------------------------------------------------------------
**
...
module i_axi_a2x_DW_axi_a2x_aw (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_AW_PYLD_W            = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW + 
                                        `i_axi_a2x_A2X_HBTYPE_W +  A2X_AWSBW + `i_axi_a2x_A2X_IDW +  A2X_AW   + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
  ...
  wire  [`i_axi_a2x_A2X_BSW-1:0]                        ws_size;     
  wire  [`i_axi_a2x_A2X_RSW-1:0]                        ws_resize; 
  wire                                        ws_last;
  wire                                        ws_fixed;
  ...
  assign aw_fifos_pop_empty  =   (wbuf_mode==`i_axi_a2x_SNF_MODE)? (aw_fifo_empty | snf_fifo_empty) : aw_fifo_empty;
  ...
  //*************************************************************************************
    ...
    if (BYPASS_SNF_W==1) begin: SNF_FIFO
      ...
      assign snf_fifo_push_n_w =  (wbuf_mode==`i_axi_a2x_SNF_MODE)? snf_fifo_push_n      : 1'b1;
      assign snf_fifo_pop_n_w  =  (wbuf_mode==`i_axi_a2x_SNF_MODE)? snf_fifo_pop_n       : 1'b1;
      assign snf_fifo_full     =  (wbuf_mode==`i_axi_a2x_SNF_MODE)? snf_fifo_full_w      : 1'b0;
      assign snf_fifo_empty    =  (wbuf_mode==`i_axi_a2x_SNF_MODE)? snf_fifo_empty_w     : 1'b0;
      assign snf_push_empty    =  (wbuf_mode==`i_axi_a2x_SNF_MODE)? snf_push_empty_w     : 1'b1;
