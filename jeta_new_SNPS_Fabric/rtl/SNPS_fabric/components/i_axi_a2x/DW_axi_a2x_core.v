...
module i_axi_a2x_DW_axi_a2x_core (/*AUTOARG*/
  ...
  // Bresp Payload
  localparam A2X_B_PYLD_W                   = A2X_INT_BSBW + `i_axi_a2x_A2X_IDW + `i_axi_a2x_A2X_BRESPW;

  // AW payload in AXI
  localparam A2X_AW_PYLD_W                  = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +`i_axi_a2x_A2X_HBTYPE_W  +
                                              A2X_INT_AWSBW + `i_axi_a2x_A2X_IDW + A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
                                              `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  // AW payload in AHB
  localparam A2X_AW_PYLD_W_AHB              = `i_axi_a2x_A2X_HBTYPE_W + A2X_INT_AWSBW + `i_axi_a2x_A2X_IDW + A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
                                              `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  // AR Payload in AXI                                     
  localparam A2X_AR_PYLD_W                  = A2X_BARW + A2X_RSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW + `i_axi_a2x_A2X_HBTYPE_W +
                                              A2X_INT_ARSBW + `i_axi_a2x_A2X_IDW + A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
                                              `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  // AR Payload in AHB                                     
  localparam A2X_AR_PYLD_W_AHB              = `i_axi_a2x_A2X_HBTYPE_W + A2X_INT_ARSBW + `i_axi_a2x_A2X_IDW + A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + 
                                              `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
 // Primary & Secondary Port W Payload
  localparam A2X_W_PP_PYLD_W                = A2X_INT_PPWSBW + `i_axi_a2x_A2X_IDW + A2X_PP_DW + A2X_PP_WSTRB_DW + 1;
  localparam A2X_W_SP_PYLD_W                = A2X_INT_WSBW + `i_axi_a2x_A2X_IDW + A2X_SP_DW + A2X_SP_WSTRB_DW + 1;

  // Primary & Secondary Port R Payload
  localparam A2X_R_PP_PYLD_W                = A2X_INT_PPRSBW + `i_axi_a2x_A2X_IDW + A2X_PP_DW + `i_axi_a2x_A2X_RRESPW + 1;
  localparam A2X_R_SP_PYLD_W                = A2X_INT_RSBW + `i_axi_a2x_A2X_IDW + A2X_SP_DW + `i_axi_a2x_A2X_RRESPW + 1;
  ...
  localparam A2X_SP_OSAW_PYLD_W            = `i_axi_a2x_A2X_RSW + 1 + `i_axi_a2x_A2X_BSW + W_PP_NUM_BYTES_LOG2 + 1 + A2X_BLW + 1; 
  ...
  localparam A2X_RDS_PYLD_W                 = `i_axi_a2x_A2X_RSW + 1 + `i_axi_a2x_A2X_BSW + PP_NUM_BYTES_LOG2 + 1;                                            

  localparam A2X_RUS_PYLD_W                 = `i_axi_a2x_A2X_RSW + 1 + BLW_PP + `i_axi_a2x_A2X_BSW + 1 + A2X_SP_NUM_BYTES_LOG2;

  localparam A2X_SP_OSAR_PYLD_W             = (A2X_DOWNSIZE==1)? A2X_RDS_PYLD_W : (A2X_UPSIZE==1)? A2X_RUS_PYLD_W : `i_axi_a2x_A2X_BSW; 

  localparam A2X_HINCR_LEN_W               = 4;

  // ID From-To Bits
  localparam AWID_FROM_BIT                  = `i_axi_a2x_A2X_IDW + A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  localparam AWID_TO_BIT                    =  A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;

  localparam ARID_FROM_BIT                  = `i_axi_a2x_A2X_IDW + A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  localparam ARID_TO_BIT                    = A2X_AW  + `i_axi_a2x_A2X_RSW + A2X_BLW + `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  
  localparam ARLEN_FROM_BIT                 =  A2X_BLW + `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  localparam ARLEN_TO_BIT                   =  `i_axi_a2x_A2X_BSW + `i_axi_a2x_A2X_BTW + `i_axi_a2x_A2X_LTW + `i_axi_a2x_A2X_CTW + `i_axi_a2x_A2X_PTW;
  ...
  input  [`i_axi_a2x_A2X_BSW-1:0]                       hsize;       // AHB size              
  input  [`i_axi_a2x_A2X_HPTW-1:0]                      hprot;       // AHB protection        
  ...
  input  [`i_axi_a2x_A2X_LTW-1:0]                       awlock_pp;   

  // AXI write data
  output                                      wready_pp;    
  input                                       wvalid_pp;   
  input                                       wlast_pp;   
  input  [`i_axi_a2x_A2X_IDW-1:0]                       wid_pp;    
  ...
  input  [`i_axi_a2x_A2X_LTW-1:0]                       arlock_pp;   
  ...
  output                                      wvalid_sp;   
  output                                      wlast_sp;   
  output [`i_axi_a2x_A2X_SP_IDW-1:0]                    wid_sp;    
  ...
  output                                      bready_sp;
  input                                       bvalid_sp;     
  input [`i_axi_a2x_A2X_IDW-1:0]                        bid_sp;       
  ...
  input                                       rvalid_sp;   
  input                                       rlast_sp;   
  input [`i_axi_a2x_A2X_IDW-1:0]                        rid_sp;    
  ...
  // Signal Decelaration
  //*************************************************************************************
  wire  [`i_axi_a2x_A2X_IDW-1:0]                        awid_sp_w;
  wire  [`i_axi_a2x_A2X_IDW-1:0]                        arid_sp_w;
  wire  [`i_axi_a2x_A2X_IDW-1:0]                        wid_sp_w;
  wire  [`i_axi_a2x_A2X_IDW-1:0]                        bid_sp_w;
  wire  [`i_axi_a2x_A2X_IDW-1:0]                        rid_sp_w;
  ...
  wire                                        aw_last_sp;
  wire                                        aw_nbuf_sp; 
  wire   [`i_axi_a2x_A2X_IDW-1:0]                       aw_id_sp;   
  wire   [`i_axi_a2x_A2X_IDW-1:0]                       ar_id_sp;   
  ...
  wire                                        wlast_pp_w;
  wire [`i_axi_a2x_A2X_IDW-1:0]                         wid_pp_w;    
  ...
  wire  [`i_axi_a2x_A2X_LTW-1:0]                        awlock_core_sp;
  wire  [`i_axi_a2x_A2X_LTW-1:0]                        arlock_core_sp;
  ...
  //*************************************************************************************
  generate 
  if (`i_axi_a2x_A2X_IDW==`i_axi_a2x_A2X_SP_IDW) begin: IDW
    ...
    assign awid_sp   = {{(`i_axi_a2x_A2X_SP_IDW-`i_axi_a2x_A2X_IDW){1'b0}}, awid_sp_w};
    assign arid_sp   = {{(`i_axi_a2x_A2X_SP_IDW-`i_axi_a2x_A2X_IDW){1'b0}}, arid_sp_w};
    assign wid_sp    = {{(`i_axi_a2x_A2X_SP_IDW-`i_axi_a2x_A2X_IDW){1'b0}}, wid_sp_w};
    assign bid_sp_w  = bid_sp[`i_axi_a2x_A2X_IDW-1:0];
    assign rid_sp_w  = rid_sp[`i_axi_a2x_A2X_IDW-1:0];
  end
  endgenerate
  ...
  generate 
    if (A2X_PP_MODE==0) begin: H2X
      ...
      assign hresp        = {`i_axi_a2x_A2X_HRESPW{1'b0}};
  ...
  assign wid_pp_w   = w_pyld_pp[A2X_W_PP_PYLD_W-A2X_INT_PPWSBW-1:A2X_W_PP_PYLD_W-A2X_INT_PPWSBW-`i_axi_a2x_A2X_IDW];
