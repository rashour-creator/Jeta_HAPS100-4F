...
module i_axi_a2x_DW_axi_a2x_h2x_r_id (/*AUTOARG*/
  ...
  input  [`i_axi_a2x_A2X_HBLW-1:0]                   hburst_i;
  output [`i_axi_a2x_A2X_HBLW-1:0]                   hburst_o;
  output                                   hburst_vld_o;
  ...
  wire                                     hburst_incr;
  wire                                     hburst_vld_w;
  reg    [`i_axi_a2x_A2X_HBLW-1:0]                   hburst_r;       
  wire   [`i_axi_a2x_A2X_HBLW-1:0]                   hburst_w;       

  //*************************************************************************************
  //*************************************************************************************
  assign hburst_incr = (hburst_vld_w)? (hburst_w==`i_axi_a2x_HBURST_INCR) : (hburst_i==`i_axi_a2x_HBURST_INCR);
  ...
  if (AR_BUF_FULL_EN==1) begin: HB
    always @(posedge clk or negedge resetn) begin: burst_r_PROC
      if (resetn == 1'b0) begin
        hburst_r      <= {`i_axi_a2x_A2X_HBLW{1'b0}}; 
        hburst_vld_r <= 1'b0; 
      end else begin
    ...
    assign hburst_o      = (hid_valid)? hburst_r     : {(`i_axi_a2x_A2X_HBLW){1'b0}}; 
    assign hburst_vld_o  = (hid_valid)? hburst_vld_r : 1'b0; 
  end else begin
    assign hburst_w      = {`i_axi_a2x_A2X_HBLW{1'b0}};
    assign hburst_vld_w  = 1'b0;
    assign hburst_o      = {(`i_axi_a2x_A2X_HBLW){1'b0}}; 
