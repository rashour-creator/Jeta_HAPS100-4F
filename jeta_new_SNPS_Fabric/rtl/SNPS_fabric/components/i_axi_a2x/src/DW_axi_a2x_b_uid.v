...
module i_axi_a2x_DW_axi_a2x_b_uid (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_B_W              = `i_axi_a2x_A2X_IDW + `i_axi_a2x_A2X_BRESPW;
  ...
  input                                      awvalid_sp; 
  input                                      awready_sp;
  input  [`i_axi_a2x_A2X_IDW-1:0]                      awid_sp;
  input                                      aw_last_sp;
  input                                      aw_nbuf_sp; 
  input                                      bvalid_sp;
  input                                      bready_sp;
  ...
  // Signal Decelaration
  //*************************************************************************************
  wire  [`i_axi_a2x_A2X_IDW-1:0]                       bid_sp;
  wire  [`i_axi_a2x_A2X_BRESPW-1:0]                    bresp_sp;
  ...
  reg   [`i_axi_a2x_A2X_IDW-1:0]                       uid_r;
  reg                                        uid_active_r; 
  ...
  //These nets are used to connect the logic under certain configuration.
  //But this may not drive some of the nets. This will not cause any functional issue.
  reg   [`i_axi_a2x_A2X_BRESPW-1:0]                    uid_resp_r;
  wire  [`i_axi_a2x_A2X_BRESPW-1:0]                    uid_resp;
