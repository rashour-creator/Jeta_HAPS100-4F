...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_mp_shrd.v#9 $ 
**
** ---------------------------------------------------------------------
**
...
//----------------------------------------------------------------------
  ...
  parameter ICM_PORT = `i_axi_AXI_HAS_BICMD;
  ...
  localparam BUS_R_PYLD_S_W
             = R_NUM_VIS_SP*(`i_axi_AXI_R_PYLD_M_W + ICM_PYLD); 
  ...
  localparam BUS_B_PYLD_S_W
             = B_NUM_VIS_SP*(`i_axi_AXI_B_PYLD_M_W + ICM_PYLD); 

  // Width of concatenated slave priorities for all visible slave ports.
  localparam R_BUS_PRIORITY_W = `i_axi_AXI_SLV_PRIORITY_W*R_NUM_VIS_SP;
  localparam B_BUS_PRIORITY_W = `i_axi_AXI_SLV_PRIORITY_W*B_NUM_VIS_SP;
