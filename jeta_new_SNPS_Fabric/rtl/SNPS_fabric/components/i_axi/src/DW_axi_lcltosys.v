...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_lcltosys.v#7 $ 
**
** ---------------------------------------------------------------------
**
  ...
  begin : gen_sys_pnums_PROC
    ...
    begin
      if(bus_p_vis[sys_pnum_intg]) begin
        ...
        // SJ: This is intended and there is no functional issue
        sys_pnum = ONE_HOT 
                   ? (1'b1 << sys_pnum_intg) 
                   : sys_pnum_intg;
        ...
        //SMD: Operator widths should be same in arithmetic operation 
        //SJ: RHS (lcl_pnum+1) is a parameter which has default width of 32
        lcl_pnum = lcl_pnum+1;  
