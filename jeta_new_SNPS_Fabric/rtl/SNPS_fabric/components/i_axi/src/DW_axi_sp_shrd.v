...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_sp_shrd.v#9 $ 
**
** ---------------------------------------------------------------------
**
...
//----------------------------------------------------------------------
  ...
  localparam BUS_AR_PYLD_S_W = AR_NUM_VIS_MP*`i_axi_AXI_AR_PYLD_S_W;

  // Width of concatenated write address channel payload vector for all
  // visible master ports.
  localparam BUS_AW_PYLD_S_W = AW_NUM_VIS_MP*`i_axi_AXI_AW_PYLD_S_W; 

  // Width of concatenated write data channel payload vector for all
  // visible master ports.
  localparam BUS_W_PYLD_S_W = W_NUM_VIS_MP*`i_axi_AXI_W_PYLD_S_W;   

  // Width of master priority busses for each channel.
  localparam AR_BUS_PRIORITY_W = `i_axi_AXI_MST_PRIORITY_W*AR_NUM_VIS_MP;
  localparam AW_BUS_PRIORITY_W = `i_axi_AXI_MST_PRIORITY_W*AW_NUM_VIS_MP;
  localparam W_BUS_PRIORITY_W = `i_axi_AXI_MST_PRIORITY_W*W_NUM_VIS_MP;
...
//----------------------------------------------------------------------
  ...
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] issued_wtx_shrd_bus_max;
  
  // Max. sized wire for issued_wtx_shrd_mst_oh_o.
  wire [`i_axi_AXI_MAX_NUM_USR_MSTS-1:0] issued_wtx_shrd_mst_oh_max;
