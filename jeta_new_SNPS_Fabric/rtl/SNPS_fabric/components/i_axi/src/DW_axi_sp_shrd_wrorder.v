...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_sp_shrd_wrorder.v#8 $ 
**
** ---------------------------------------------------------------------
**
...
module i_axi_DW_axi_sp_shrd_wrorder (
  // Inputs - System
  aclk_i,
  aresetn_i,
...
//----------------------------------------------------------------------
  ...
  reg [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] cpl_tx_bus_max;
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] cpl_tx_bus_max_n;
  ...
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] fifo_empty_bus_max;
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] fifo_nxt_empty_bus_max;
  ...
  // 1 per system slave.
  reg [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] issued_slvnum_max; 
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] issued_slvnum_max_n;
  ...
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] has_ddctd_w_s_max;
  ...
  always @(*) begin : issued_slvnum_max_PROC
    issued_slvnum_max = {`i_axi_AXI_MAX_NUM_MST_SLVS{1'b0}};
  ...
  always @(*) begin : cpl_tx_bus_max_PROC
    cpl_tx_bus_max = {`i_axi_AXI_MAX_NUM_MST_SLVS{1'b0}};
