...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_dfltslv.v#8 $ 
**
** ---------------------------------------------------------------------
**
...
module i_axi_DW_axi_dfltslv(
  ...
  input [`i_axi_AXI_BLW-1:0]  arlen_i;         // Burst Length
  //spyglass disable_block W240
  //SMD: An input has been declared but is not read
  //SJ: These ports are not used 
  input [`i_axi_AXI_AW-1:0]  araddr_i;
  input [`i_axi_AXI_BSW-1:0]  arsize_i;
  input [`i_axi_AXI_LTW-1:0]  arlock_i;
  input [`i_axi_AXI_BTW-1:0]  arburst_i;
  input [`i_axi_AXI_CTW-1:0]  arcache_i;
  input [`i_axi_AXI_PTW-1:0]  arprot_i;
  ...
  output [`i_axi_AXI_RRW-1:0]   rresp_o;     // Read response
  output [`i_axi_AXI_DW-1:0]    rdata_o;     // Read data
  ...
  input [`i_axi_AXI_BLW-1:0] awlen_i;           // Burst length
  input [`i_axi_AXI_AW-1:0]  awaddr_i;
  input [`i_axi_AXI_BSW-1:0] awsize_i;
  input [`i_axi_AXI_LTW-1:0] awlock_i;
  input [`i_axi_AXI_BTW-1:0] awburst_i;
  input [`i_axi_AXI_CTW-1:0] awcache_i;
  input [`i_axi_AXI_PTW-1:0] awprot_i;
  //spyglass enable_block W240
  ...
  //SMD: An input has been declared but is not read
  //SJ: These ports are not used 
  input [`i_axi_AXI_DW-1:0]    wdata_i;         // Write data 
  input [`i_axi_AXI_SW-1:0]    wstrb_i;         // Write strobes
  //spyglass enable_block W240
  ...
  output [`i_axi_AXI_BRW-1:0]   bresp_o;     // Write response
  ...
  reg [`i_axi_AXI_BLW-1:0] arlen_r;  // Burst Length
  ...
  //SJ: RHS (arlen_r-1) is a parameter which has default width of 32
  always @ (posedge aclk_i or negedge aresetn_i)
  begin : arlen_r_PROC 
    if (!aresetn_i)
      arlen_r <= {`i_axi_AXI_BLW{1'b0}};
    else
  ...
  // decode errors.
  assign rdata_o     = {`i_axi_AXI_DW{1'b0}};
  assign rresp_o     = `i_axi_AXI_RESP_DECERR;    
  ...
  //ccx_cond: ; ; 10 ; This condition can be covered by asserting valid before ready.
  ...
  // a decode error.
  assign bresp_o = `i_axi_AXI_RESP_DECERR;  
