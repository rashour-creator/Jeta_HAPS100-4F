...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_systolcl.v#10 $ 
**
** ---------------------------------------------------------------------
**
...
//----------------------------------------------------------------------
  ...
  // configurations.
  output [`i_axi_AXI_MAX_NUM_USR_MSTS-1:0] bidi_sys_pnum_oh_o;
  ...
  wire [`i_axi_AXI_MAX_NUM_MST_SLVS-1:0] bus_p_vis; // Bus containing all
                                              // port visibility 
                                              // parameters.
  ...
  wire [`i_axi_AXI_MAX_NUM_USR_MSTS-1:0] bidi_mp_dec_bus;
  ...
  wire [SYSPNUM_W*`i_axi_AXI_NUM_MST_THRU_ICM1-1:0] sys_msts_icm1;
  wire [SYSPNUM_W*`i_axi_AXI_NUM_MST_THRU_ICM2-1:0] sys_msts_icm2;
  wire [SYSPNUM_W*`i_axi_AXI_NUM_MST_THRU_ICM3-1:0] sys_msts_icm3;
  wire [SYSPNUM_W*`i_axi_AXI_NUM_MST_THRU_ICM4-1:0] sys_msts_icm4;
  wire    dummy_wire  ;
  ...
  // SJ : This is not a functional issue, this is as per the requirement.
  //      Hence this can be waived.
  assign msts1_thru_icm1 = (`i_axi_AXI_ALLOW_MST1_ICM1-1);
  assign msts2_thru_icm1 = (`i_axi_AXI_ALLOW_MST2_ICM1-1);
  assign msts3_thru_icm1 = (`i_axi_AXI_ALLOW_MST3_ICM1-1);
  assign msts4_thru_icm1 = (`i_axi_AXI_ALLOW_MST4_ICM1-1);
  assign msts5_thru_icm1 = (`i_axi_AXI_ALLOW_MST5_ICM1-1);
  assign msts6_thru_icm1 = (`i_axi_AXI_ALLOW_MST6_ICM1-1);
  assign msts7_thru_icm1 = (`i_axi_AXI_ALLOW_MST7_ICM1-1);
  assign msts8_thru_icm1 = (`i_axi_AXI_ALLOW_MST8_ICM1-1);
  
  assign msts1_thru_icm2 = (`i_axi_AXI_ALLOW_MST1_ICM2-1);
  assign msts2_thru_icm2 = (`i_axi_AXI_ALLOW_MST2_ICM2-1);
  assign msts3_thru_icm2 = (`i_axi_AXI_ALLOW_MST3_ICM2-1);
  assign msts4_thru_icm2 = (`i_axi_AXI_ALLOW_MST4_ICM2-1);
  assign msts5_thru_icm2 = (`i_axi_AXI_ALLOW_MST5_ICM2-1);
  assign msts6_thru_icm2 = (`i_axi_AXI_ALLOW_MST6_ICM2-1);
  assign msts7_thru_icm2 = (`i_axi_AXI_ALLOW_MST7_ICM2-1);
  assign msts8_thru_icm2 = (`i_axi_AXI_ALLOW_MST8_ICM2-1);

  assign msts1_thru_icm3 = (`i_axi_AXI_ALLOW_MST1_ICM3-1);
  assign msts2_thru_icm3 = (`i_axi_AXI_ALLOW_MST2_ICM3-1);
  assign msts3_thru_icm3 = (`i_axi_AXI_ALLOW_MST3_ICM3-1);
  assign msts4_thru_icm3 = (`i_axi_AXI_ALLOW_MST4_ICM3-1);
  assign msts5_thru_icm3 = (`i_axi_AXI_ALLOW_MST5_ICM3-1);
  assign msts6_thru_icm3 = (`i_axi_AXI_ALLOW_MST6_ICM3-1);
  assign msts7_thru_icm3 = (`i_axi_AXI_ALLOW_MST7_ICM3-1);
  assign msts8_thru_icm3 = (`i_axi_AXI_ALLOW_MST8_ICM3-1);

  assign msts1_thru_icm4 = (`i_axi_AXI_ALLOW_MST1_ICM4-1);
  assign msts2_thru_icm4 = (`i_axi_AXI_ALLOW_MST2_ICM4-1);
  assign msts3_thru_icm4 = (`i_axi_AXI_ALLOW_MST3_ICM4-1);
  assign msts4_thru_icm4 = (`i_axi_AXI_ALLOW_MST4_ICM4-1);
  assign msts5_thru_icm4 = (`i_axi_AXI_ALLOW_MST5_ICM4-1);
  assign msts6_thru_icm4 = (`i_axi_AXI_ALLOW_MST6_ICM4-1);
  assign msts7_thru_icm4 = (`i_axi_AXI_ALLOW_MST7_ICM4-1);
  assign msts8_thru_icm4 = (`i_axi_AXI_ALLOW_MST8_ICM4-1);
...
//  The logic for bidi_mp1_dec is changed becoz of Lint Error
  ...
  begin: bidi_mp1_dec_PROC     
    bidi_mp1_dec =  ~{bidi_mp_dec_bus[`i_axi_AXI_NUM_MASTERS-1:1]}; 
  end
  ...
  begin : bidi_mp2_dec_PROC
    ...
    // SMD: Unequal length in arithmatic comparison operator
    // SJ: RHS is a parameter which has default width of 32
    if(((`i_axi_AXI_SYS_NUM_FOR_M2-1) == sys_pnum_i) & p1_vis) begin
  ...
  begin : bidi_mp3_dec_PROC
    ...
    // SMD: Unequal length in arithmatic comparison operator
    // SJ: RHS is a parameter which has default width of 32
    if(((`i_axi_AXI_SYS_NUM_FOR_M3-1)== sys_pnum_i) & p2_vis) begin
    // spyglass enable_block W362 STARC05-2.10.3.1
      bidi_mp3_dec = 1'b1;
    end
  end // bidi_mp1_dec_PROC
  ...
  begin : bidi_mp4_dec_PROC
    ...
    // SMD: Unequal length in arithmatic comparison operator
    // SJ: RHS is a parameter which has default width of 32
    if(((`i_axi_AXI_SYS_NUM_FOR_M4-1) == sys_pnum_i) & p3_vis) begin
    // spyglass enable_block W362 STARC05-2.10.3.1
      bidi_mp4_dec = 1'b1;
    end
  end // bidi_mp1_dec_PROC
  ...
  // SMD: Unequal length in arithmatic comparison operator
  // SJ: RHS is a parameter which has default width of 32
  assign bidi_mp5_dec = p4_vis & ((`i_axi_AXI_SYS_NUM_FOR_M5-1) == sys_pnum_i);
  assign bidi_mp6_dec = p5_vis & ((`i_axi_AXI_SYS_NUM_FOR_M6-1) == sys_pnum_i);
  assign bidi_mp7_dec = p6_vis & ((`i_axi_AXI_SYS_NUM_FOR_M7-1) == sys_pnum_i);
  assign bidi_mp8_dec = p7_vis & ((`i_axi_AXI_SYS_NUM_FOR_M8-1) == sys_pnum_i);
  assign bidi_mp9_dec = p8_vis & ((`i_axi_AXI_SYS_NUM_FOR_M9-1) == sys_pnum_i);
  assign bidi_mp10_dec = p9_vis & ((`i_axi_AXI_SYS_NUM_FOR_M10-1) == sys_pnum_i);
  assign bidi_mp11_dec = p10_vis & ((`i_axi_AXI_SYS_NUM_FOR_M11-1) == sys_pnum_i);
  assign bidi_mp12_dec = p11_vis & ((`i_axi_AXI_SYS_NUM_FOR_M12-1) == sys_pnum_i);
  assign bidi_mp13_dec = p12_vis & ((`i_axi_AXI_SYS_NUM_FOR_M13-1) == sys_pnum_i);
  assign bidi_mp14_dec = p13_vis & ((`i_axi_AXI_SYS_NUM_FOR_M14-1) == sys_pnum_i);
  assign bidi_mp15_dec = p14_vis & ((`i_axi_AXI_SYS_NUM_FOR_M15-1) == sys_pnum_i);
  assign bidi_mp16_dec = p15_vis & ((`i_axi_AXI_SYS_NUM_FOR_M16-1) == sys_pnum_i);
  // spyglass enable_block W362 STARC05-2.10.3.1
