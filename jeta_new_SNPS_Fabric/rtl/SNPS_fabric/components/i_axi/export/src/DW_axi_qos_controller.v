...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_qos_controller.v#3 $ 
--
...
module i_axi_DW_axi_qos_controller (
...
//------------------------------------------------------------------------------
i_axi_DW_axi_qos_token_generator
 #(
   .NC(NC),
   .PL_ARB(PL_ARB)
   ) 
