...
// Revision: $Id: //dwh/DW_ocb/DW_axi/axi_dev_br/src/DW_axi_arbiter_fcfs.v#15 $ 
//
...
`include "DW_axi_all_includes.vh"
  ...
  module i_axi_DW_axi_arbiter_fcfs (
  clk,
  rst_n,
  init_n,
  enable,
...
integer i3, j3;
  ...
  //spyglass disable_block W163 W164a
  ...
  //spyglass enable_block W163 W164a
  ...
  // SMD: Bit-width mismatch between function call argument
