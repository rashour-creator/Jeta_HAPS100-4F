...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/axi_dev_br/src/DW_axi_a2x_b.v#8 $ 
**
** --------------------------------------------------------------------
**
** File     : DW_axi_a2x_b.v
...
module i_axi_a2x_1_DW_axi_a2x_b (/*AUTOARG*/
   // Inputs
   clk_pp, 
   resetn_pp, 
   clk_sp, 
