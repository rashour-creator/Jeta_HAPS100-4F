...
**---------------------------------------------------------------------------------------------------------------------
*/
`include "/slowfs/de06-cae-scratch/work/reem/jeta_capim_new_SNPS_fabric/rtl/SNPS_fabric/components/i_axi_a2x_1/DW_axi_a2x_all_includes.vh"
...
module i_axi_a2x_1_DW_axi_a2x_w (/*AUTOARG*/
  ...
  localparam SP_OSAW_FIFO_PYLD_W  = (A2X_DOWNSIZE==1)?  (`i_axi_a2x_1_A2X_RSW + 1 + `i_axi_a2x_1_A2X_BSW + A2X_PP_NUM_BYTES_LOG2 + 1 + A2X_BLW + 1) :
                                    ((A2X_UPSIZE==1) && (A2X_SP_ENDIAN==0))? (A2X_BLW + 1) :
                                    ((A2X_PP_MODE==1) && (A2X_UPSIZE==1) && (A2X_SP_ENDIAN==3))? (1 + 1 + `i_axi_a2x_1_A2X_BSW + A2X_BLW + 1) :
                                    ((A2X_PP_MODE==0) && (A2X_UPSIZE==1) && (A2X_SP_ENDIAN==3))? (1 + `i_axi_a2x_1_A2X_BSW + A2X_BLW + 1) :
                                    ((A2X_PP_MODE==0) && (A2X_SP_ENDIAN==3))? (`i_axi_a2x_1_A2X_BSW + A2X_BLW + 1) :
                                    (A2X_PP_MODE==0)? (A2X_BLW + 1) : 
                                    (A2X_SP_ENDIAN==3)? `i_axi_a2x_1_A2X_BSW : 
                                    ((A2X_LOCKED==1) && (A2X_BRESP_MODE==0))? 1 :0;
                                      
  // Primary Port OSAW FIFO Payload Width 
  localparam A2X_PP_OSAW_PYLD_W          =  1 + `i_axi_a2x_1_A2X_BTW + `i_axi_a2x_1_A2X_BSW + A2X_BLW + 13; 

  // Downsizing Payload & SP Control 
  localparam A2X_WDS_PYLD_W              = `i_axi_a2x_1_A2X_RSW + 1 + `i_axi_a2x_1_A2X_BSW + A2X_PP_NUM_BYTES_LOG2 + 1;
  ...
  localparam A2X_SP_OSAW_PYLD_W          = `i_axi_a2x_1_A2X_RSW + 1 + `i_axi_a2x_1_A2X_BSW + PP_NUM_BYTES_LOG2 + 1 + A2X_BLW + 1;
  ...
  wire  [`i_axi_a2x_1_A2X_BSW-1:0]                        pp_endian_size_i; 
  wire  [`i_axi_a2x_1_A2X_BSW-1:0]                        sp_endian_size_i; 
  wire  [`i_axi_a2x_1_A2X_BSW-1:0]                        upk_endian_size;     
  ...
  //These are dummy wires used to connect the unconnected ports.
  //     Hence will not drive any nets.
  wire   [`i_axi_a2x_1_A2X_IDW-1:0]                       awid_pp;    
  wire   [`i_axi_a2x_1_A2X_LTW-1:0]                       awlock_pp;   
  wire   [`i_axi_a2x_1_A2X_CTW-1:0]                       awcache_pp; 
  wire   [`i_axi_a2x_1_A2X_PTW-1:0]                       awprot_pp; 
  wire   [A2X_AWSBW-1:0]                      awsideband_pp;
  wire                                        aw_hburst_type_pp;
  wire   [A2X_AW-1:0]                         awaddr_pp; 
  wire   [A2X_BLW-1:0]                        awlen_pp; 
  wire   [`i_axi_a2x_1_A2X_BSW-1:0]                       awsize_pp;     
  wire   [`i_axi_a2x_1_A2X_BTW-1:0]                       awburst_pp;   
  wire                                        awresize_pp;

  // Outputs from SP OSAW FIFO. 
  wire  [`i_axi_a2x_1_A2X_BSW-1:0]                        sp_osaw_size_o;     
  wire  [`i_axi_a2x_1_A2X_RSW-1:0]                        sp_osaw_resize_o; 
  ...
  if ((A2X_PP_ENDIAN==3) || ((A2X_DOWNSIZE==1) && (BYPASS_SNF_W==0)) || (A2X_UPSIZE==1)) begin: PP_OW_FIFO
    ...
    assign pp_osaw_pyld_i      =  ((A2X_DOWNSIZE==1) && (BYPASS_SNF_W==0))? ds_pp_osaw_pyld : 
                                  (A2X_UPSIZE==1)? us_pp_osaw_pyld : {1'b0, {`i_axi_a2x_1_A2X_BTW{1'b0}}, awsize_pp, {A2X_BLW{1'b0}}, 13'd0}; 
    ...
    // A2X Endian Size.
    assign pp_endian_size_i =  pp_osaw_pyld_o[(`i_axi_a2x_1_A2X_BSW+A2X_BLW+13)-1:A2X_BLW+13] ;
  ...
  if ((A2X_PP_MODE==0) || (A2X_DOWNSIZE==1) || (A2X_UPSIZE==1) ||  (A2X_SP_ENDIAN!=0) || ((A2X_LOCKED==1) && (A2X_BRESP_MODE==0))) begin: SPOSAWFIFO
    ...
    wire  [`i_axi_a2x_1_A2X_BSW-1:0]                        sp_osaw_size_i;     
    wire  [`i_axi_a2x_1_A2X_RSW-1:0]                        sp_osaw_resize_i; 
    wire                                        sp_osaw_last_i;
    ...
    wire  [`i_axi_a2x_1_A2X_BSW-1:0]                        us_endian_size;
    ...
    if (A2X_DOWNSIZE==1) begin
      ...
      assign sp_osaw_size_o   = {`i_axi_a2x_1_A2X_BSW{1'b0}}; 
    end else if ((A2X_PP_MODE==1) && (A2X_UPSIZE==1) && (A2X_SP_ENDIAN==3)) begin
    ...
    if (((A2X_PP_MODE==1)) && (A2X_UPSIZE==1) && (A2X_SP_ENDIAN==3)) begin
      ...
      assign us_endian_size = {`i_axi_a2x_1_A2X_BSW{1'b0}};
    end
  ...
  if (A2X_SP_ENDIAN!=0) begin: LE_TO_BE_8
    ...
    i_axi_a2x_1_DW_axi_a2x_x2x_et
     #(
      ...
      ,.A2X_UBB                (`i_axi_a2x_1_A2X_WUSER_BITS_PER_BYTE) 
