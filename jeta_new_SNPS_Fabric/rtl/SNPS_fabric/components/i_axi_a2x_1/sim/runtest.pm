...
@ISA = qw(Exporter);
use lib "/remote/sdgedt/tools/reem/SNPS_FABRIC/Subsystem1/components/i_axi_a2x_1/scratch/rce/perl/testJSONLib/lib";
use testjson;

my $PATH_TO_JSON_PL_SCRIPTS="/remote/sdgedt/tools/reem/SNPS_FABRIC/Subsystem1/components/i_axi_a2x_1/scratch/rce/perl/testJSONLib/lib";

my $file_prefix="";

my $design_prefix="i_axi_a2x_1_";

my $macro_prefix="i_axi_a2x_1_";
...
if (exists $main::ccparams{'i_axi_a2x_1_USE_FOUNDATION'}) 
   {
if ($main::ccparams{'i_axi_a2x_1_USE_FOUNDATION'} eq 1) 
     {
      if (exists $ENV{SYNOPSYS}) {
