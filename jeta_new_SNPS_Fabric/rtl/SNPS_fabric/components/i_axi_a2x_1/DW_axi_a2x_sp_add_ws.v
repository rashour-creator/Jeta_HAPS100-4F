...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/axi_dev_br/src/DW_axi_a2x_sp_add_ws.v#6 $ 
// --------------------------------------------------------------------
*/
...
// **************************************************************************************
module i_axi_a2x_1_DW_axi_a2x_sp_add_ws (/*AUTOARG*/
  clk, resetn, wrap, addr_i, alast_ac, a_ready_i, a_fifo_empty, sp_os_fifo_vld, active_ac,
  size_i, alen_i, alast_as, active_r, second_burst, split, addr2, alen2, snf_wlast,
  trans_en
);
  ...
  input                                      snf_wlast; 
  input   [`i_axi_a2x_1_A2X_BSW-1:0]                     size_i;   
