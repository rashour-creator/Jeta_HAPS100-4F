...
`ifdef i_axi_a2x_1_A2X_AHB_EBT_MODE
   `undef i_axi_a2x_1_A2X_AHB_EBT_MODE
`endif
`ifdef i_axi_a2x_1_A2X_AHB_INTERFACE_TYPE
   `undef i_axi_a2x_1_A2X_AHB_INTERFACE_TYPE
`endif
`ifdef i_axi_a2x_1_A2X_AHB_LITE_MODE
   `undef i_axi_a2x_1_A2X_AHB_LITE_MODE
`endif
`ifdef i_axi_a2x_1_A2X_AHB_LOCKED
   `undef i_axi_a2x_1_A2X_AHB_LOCKED
`endif
`ifdef i_axi_a2x_1_A2X_AHB_RRECALL_DEPTH
   `undef i_axi_a2x_1_A2X_AHB_RRECALL_DEPTH
`endif
`ifdef i_axi_a2x_1_A2X_AHB_SCALAR_HRESP
   `undef i_axi_a2x_1_A2X_AHB_SCALAR_HRESP
`endif
`ifdef i_axi_a2x_1_A2X_AHB_SPLIT_MODE
   `undef i_axi_a2x_1_A2X_AHB_SPLIT_MODE
`endif
`ifdef i_axi_a2x_1_A2X_APB_MODE
   `undef i_axi_a2x_1_A2X_APB_MODE
`endif
`ifdef i_axi_a2x_1_A2X_ARSBW
   `undef i_axi_a2x_1_A2X_ARSBW
`endif
`ifdef i_axi_a2x_1_A2X_AR_FIFO_DEPTH
   `undef i_axi_a2x_1_A2X_AR_FIFO_DEPTH
`endif
`ifdef i_axi_a2x_1_A2X_AR_FIFO_DEPTH_LOG2
   `undef i_axi_a2x_1_A2X_AR_FIFO_DEPTH_LOG2
`endif
`ifdef i_axi_a2x_1_A2X_AR_SP_PIPELINE
   `undef i_axi_a2x_1_A2X_AR_SP_PIPELINE
`endif
`ifdef i_axi_a2x_1_A2X_ASYNC_CLKS
   `undef i_axi_a2x_1_A2X_ASYNC_CLKS
`endif
`ifdef i_axi_a2x_1_A2X_AUTO_LINK_SPLIT_MODE
   `undef i_axi_a2x_1_A2X_AUTO_LINK_SPLIT_MODE
`endif
`ifdef i_axi_a2x_1_A2X_AW
   `undef i_axi_a2x_1_A2X_AW
`endif
`ifdef i_axi_a2x_1_A2X_AWSBW
   `undef i_axi_a2x_1_A2X_AWSBW
`endif
`ifdef A2X_AW_64
   `undef A2X_AW_64
`endif
`ifdef i_axi_a2x_1_A2X_AW_FIFO_DEPTH
   `undef i_axi_a2x_1_A2X_AW_FIFO_DEPTH
`endif
`ifdef i_axi_a2x_1_A2X_AW_FIFO_DEPTH_LOG2
   `undef i_axi_a2x_1_A2X_AW_FIFO_DEPTH_LOG2
`endif
`ifdef i_axi_a2x_1_A2X_AW_SP_PIPELINE
   `undef i_axi_a2x_1_A2X_AW_SP_PIPELINE
`endif
`ifdef i_axi_a2x_1_A2X_AXI_INTERFACE_TYPE
   `undef i_axi_a2x_1_A2X_AXI_INTERFACE_TYPE
`endif
`ifdef i_axi_a2x_1_A2X_A_UBW
   `undef i_axi_a2x_1_A2X_A_UBW
`endif
...
`ifdef i_axi_a2x_1_A2X_BLW
   `undef i_axi_a2x_1_A2X_BLW
`endif
`ifdef i_axi_a2x_1_A2X_BOUNDARY_W
   `undef i_axi_a2x_1_A2X_BOUNDARY_W
`endif
`ifdef i_axi_a2x_1_A2X_BRESPW
   `undef i_axi_a2x_1_A2X_BRESPW
`endif
`ifdef i_axi_a2x_1_A2X_BRESP_FIFO_DEPTH
   `undef i_axi_a2x_1_A2X_BRESP_FIFO_DEPTH
`endif
`ifdef i_axi_a2x_1_A2X_BRESP_FIFO_DEPTH_LOG2
   `undef i_axi_a2x_1_A2X_BRESP_FIFO_DEPTH_LOG2
`endif
`ifdef i_axi_a2x_1_A2X_BRESP_MODE
   `undef i_axi_a2x_1_A2X_BRESP_MODE
`endif
`ifdef i_axi_a2x_1_A2X_BRESP_ORDER
   `undef i_axi_a2x_1_A2X_BRESP_ORDER
`endif
`ifdef i_axi_a2x_1_A2X_BSBW
   `undef i_axi_a2x_1_A2X_BSBW
`endif
`ifdef i_axi_a2x_1_A2X_BSW
   `undef i_axi_a2x_1_A2X_BSW
`endif
`ifdef i_axi_a2x_1_A2X_BTW
   `undef i_axi_a2x_1_A2X_BTW
`endif
`ifdef i_axi_a2x_1_A2X_B_OSW_LIMIT
   `undef i_axi_a2x_1_A2X_B_OSW_LIMIT
`endif
`ifdef i_axi_a2x_1_A2X_B_OSW_LIMIT_LOG2
   `undef i_axi_a2x_1_A2X_B_OSW_LIMIT_LOG2
`endif
`ifdef i_axi_a2x_1_A2X_B_OSW_LIMIT_P1
   `undef i_axi_a2x_1_A2X_B_OSW_LIMIT_P1
`endif
`ifdef i_axi_a2x_1_A2X_CLK_IS_SYNC
   `undef i_axi_a2x_1_A2X_CLK_IS_SYNC
`endif
`ifdef i_axi_a2x_1_A2X_CLK_MODE
   `undef i_axi_a2x_1_A2X_CLK_MODE
`endif
`ifdef i_axi_a2x_1_A2X_CTW
   `undef i_axi_a2x_1_A2X_CTW
`endif
`ifdef i_axi_a2x_1_A2X_DOWNSIZE
   `undef i_axi_a2x_1_A2X_DOWNSIZE
`endif
`ifdef i_axi_a2x_1_A2X_DS_RATIO_2
   `undef i_axi_a2x_1_A2X_DS_RATIO_2
`endif
`ifdef i_axi_a2x_1_A2X_DS_RATIO_4
   `undef i_axi_a2x_1_A2X_DS_RATIO_4
`endif
`ifdef i_axi_a2x_1_A2X_DS_RATIO_8
   `undef i_axi_a2x_1_A2X_DS_RATIO_8
`endif
`ifdef i_axi_a2x_1_A2X_DUAL_CLK
   `undef i_axi_a2x_1_A2X_DUAL_CLK
`endif
`ifdef i_axi_a2x_1_A2X_HAS_ACELITE
   `undef i_axi_a2x_1_A2X_HAS_ACELITE
`endif
`ifdef A2X_HAS_AHB5
   `undef A2X_HAS_AHB5
`endif
...
`ifdef i_axi_a2x_1_F_SYNC_TYPE_PP
   `undef i_axi_a2x_1_F_SYNC_TYPE_PP
`endif
`ifdef i_axi_a2x_1_F_SYNC_TYPE_SP
   `undef i_axi_a2x_1_F_SYNC_TYPE_SP
`endif
`ifdef i_axi_a2x_1_HBURST_INCR
   `undef i_axi_a2x_1_HBURST_INCR
`endif
`ifdef i_axi_a2x_1_HBURST_INCR16
   `undef i_axi_a2x_1_HBURST_INCR16
`endif
`ifdef i_axi_a2x_1_HBURST_INCR4
   `undef i_axi_a2x_1_HBURST_INCR4
`endif
`ifdef i_axi_a2x_1_HBURST_INCR8
   `undef i_axi_a2x_1_HBURST_INCR8
`endif
`ifdef i_axi_a2x_1_HBURST_SINGLE
   `undef i_axi_a2x_1_HBURST_SINGLE
`endif
`ifdef i_axi_a2x_1_HBURST_WRAP16
   `undef i_axi_a2x_1_HBURST_WRAP16
`endif
`ifdef i_axi_a2x_1_HBURST_WRAP4
   `undef i_axi_a2x_1_HBURST_WRAP4
`endif
`ifdef i_axi_a2x_1_HBURST_WRAP8
   `undef i_axi_a2x_1_HBURST_WRAP8
`endif
`ifdef i_axi_a2x_1_HPROT_BUFF
   `undef i_axi_a2x_1_HPROT_BUFF
`endif
`ifdef i_axi_a2x_1_HPROT_CACHE
   `undef i_axi_a2x_1_HPROT_CACHE
`endif
`ifdef i_axi_a2x_1_HPROT_DATA
   `undef i_axi_a2x_1_HPROT_DATA
`endif
`ifdef i_axi_a2x_1_HPROT_PRIV
   `undef i_axi_a2x_1_HPROT_PRIV
`endif
`ifdef i_axi_a2x_1_HRESP_ERROR
   `undef i_axi_a2x_1_HRESP_ERROR
`endif
`ifdef i_axi_a2x_1_HRESP_OKAY
   `undef i_axi_a2x_1_HRESP_OKAY
`endif
`ifdef i_axi_a2x_1_HRESP_RETRY
   `undef i_axi_a2x_1_HRESP_RETRY
`endif
`ifdef i_axi_a2x_1_HRESP_SPLIT
   `undef i_axi_a2x_1_HRESP_SPLIT
`endif
`ifdef i_axi_a2x_1_HSIZE_1024
   `undef i_axi_a2x_1_HSIZE_1024
`endif
`ifdef i_axi_a2x_1_HSIZE_1024BIT
   `undef i_axi_a2x_1_HSIZE_1024BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_128
   `undef i_axi_a2x_1_HSIZE_128
`endif
`ifdef i_axi_a2x_1_HSIZE_128BIT
   `undef i_axi_a2x_1_HSIZE_128BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_16
   `undef i_axi_a2x_1_HSIZE_16
`endif
`ifdef i_axi_a2x_1_HSIZE_16BIT
   `undef i_axi_a2x_1_HSIZE_16BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_256
   `undef i_axi_a2x_1_HSIZE_256
`endif
`ifdef i_axi_a2x_1_HSIZE_256BIT
   `undef i_axi_a2x_1_HSIZE_256BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_32
   `undef i_axi_a2x_1_HSIZE_32
`endif
`ifdef i_axi_a2x_1_HSIZE_32BIT
   `undef i_axi_a2x_1_HSIZE_32BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_512
   `undef i_axi_a2x_1_HSIZE_512
`endif
`ifdef i_axi_a2x_1_HSIZE_512BIT
   `undef i_axi_a2x_1_HSIZE_512BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_64
   `undef i_axi_a2x_1_HSIZE_64
`endif
`ifdef i_axi_a2x_1_HSIZE_64BIT
   `undef i_axi_a2x_1_HSIZE_64BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_8
   `undef i_axi_a2x_1_HSIZE_8
`endif
`ifdef i_axi_a2x_1_HSIZE_8BIT
   `undef i_axi_a2x_1_HSIZE_8BIT
`endif
`ifdef i_axi_a2x_1_HSIZE_BYTE
   `undef i_axi_a2x_1_HSIZE_BYTE
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD1024
   `undef i_axi_a2x_1_HSIZE_WORD1024
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD128
   `undef i_axi_a2x_1_HSIZE_WORD128
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD16
   `undef i_axi_a2x_1_HSIZE_WORD16
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD256
   `undef i_axi_a2x_1_HSIZE_WORD256
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD32
   `undef i_axi_a2x_1_HSIZE_WORD32
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD512
   `undef i_axi_a2x_1_HSIZE_WORD512
`endif
`ifdef i_axi_a2x_1_HSIZE_WORD64
   `undef i_axi_a2x_1_HSIZE_WORD64
`endif
`ifdef i_axi_a2x_1_HTRANS_BUSY
   `undef i_axi_a2x_1_HTRANS_BUSY
`endif
`ifdef i_axi_a2x_1_HTRANS_IDLE
   `undef i_axi_a2x_1_HTRANS_IDLE
`endif
`ifdef i_axi_a2x_1_HTRANS_NSEQ
   `undef i_axi_a2x_1_HTRANS_NSEQ
`endif
`ifdef i_axi_a2x_1_HTRANS_SEQ
   `undef i_axi_a2x_1_HTRANS_SEQ
`endif
`ifdef i_axi_a2x_1_SIM_REORDER
   `undef i_axi_a2x_1_SIM_REORDER
`endif
`ifdef i_axi_a2x_1_SNF_MODE
   `undef i_axi_a2x_1_SNF_MODE
`endif
...
`ifdef i_axi_a2x_1_USE_FOUNDATION
   `undef i_axi_a2x_1_USE_FOUNDATION
`endif
`ifdef i_axi_a2x_1___GUARD__DW_AXI_A2X_ALL_INCLUDES__VH__
   `undef i_axi_a2x_1___GUARD__DW_AXI_A2X_ALL_INCLUDES__VH__
`endif
`ifdef i_axi_a2x_1___GUARD__DW_AXI_A2X_BCM_PARAMS__VH__
   `undef i_axi_a2x_1___GUARD__DW_AXI_A2X_BCM_PARAMS__VH__
`endif
`ifdef i_axi_a2x_1___GUARD__DW_AXI_A2X_CC_CONSTANTS__VH__
   `undef i_axi_a2x_1___GUARD__DW_AXI_A2X_CC_CONSTANTS__VH__
`endif
`ifdef i_axi_a2x_1___GUARD__DW_AXI_A2X_DEFINE_CONSTANTS__VH__
   `undef i_axi_a2x_1___GUARD__DW_AXI_A2X_DEFINE_CONSTANTS__VH__
`endif
`define i_axi_a2x_1_cb_dummy_parameter_definition 1
`undef  i_axi_a2x_1_cb_dummy_parameter_definition
`ifdef DUMMY
  `undef DUMMY
`endif
