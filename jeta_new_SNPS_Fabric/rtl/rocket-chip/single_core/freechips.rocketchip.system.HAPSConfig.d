...
run-asm-p-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64si-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-p-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64si-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-p-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64si-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-p-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64si-p-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'

run-asm-tests: $(addprefix $(output_dir)/, $(addsuffix .out, $(rv64um-v-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64si-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-tests-debug: $(addprefix $(output_dir)/, $(addsuffix .vpd, $(rv64um-v-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64si-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.vpd,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-tests-fst: $(addprefix $(output_dir)/, $(addsuffix .fst, $(rv64um-v-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64si-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $(patsubst %.fst,%.out,$^) /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
run-asm-tests-fast: $(addprefix $(output_dir)/, $(addsuffix .run, $(rv64um-v-asm-tests) $(rv64mi-p-asm-tests) $(rv64ui-p-asm-tests) $(rv64uc-p-asm-tests) $(rv64ua-p-asm-tests) $(rv64uf-v-asm-tests) $(rv64uf-p-asm-tests) $(rv64ud-p-asm-tests) $(rv64ud-v-asm-tests) $(rv64ua-v-asm-tests) $(rv64uc-v-asm-tests) $(rv64si-p-asm-tests) $(rv64ui-v-asm-tests)))
	@echo; perl -ne 'print "  [$$1] $$ARGV \t$$2\n" if( /\*{3}(.{8})\*{3}(.*)/ || /ASSERTION (FAILED)/i )' $^ /dev/null | perl -ne 'if(/(.*)/){print "$$1\n\n"; exit(1) if eof()}'
