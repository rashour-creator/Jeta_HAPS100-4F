...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_w_upk.v#1 $ 
// --------------------------------------------------------------------
*/
...
// write data fifo. 
// **************************************************************************************
module i_axi_a2x_1_DW_axi_a2x_w_upk (/*AUTOARG*/
   // Outputs
 ...
 // assign pp_size_1hot[A2X_PP_MAX_SIZE:0] = pp_size_1hot_r[A2X_PP_MAX_SIZE:0];
  ...
  // Data Mux One-Hot Decode
   i_axi_a2x_1_DW_axi_a2x_busmux_ohsel
    #(
