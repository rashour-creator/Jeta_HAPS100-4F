...
// File Version     :        $Revision: #104 $ 
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x.v#104 $ 
**
** --------------------------------------------------------------------
**
** File     : DW_axi_a2x.v
...
//ccx_module: DW_axi_a2x_bcm06 ; This module is verified in a dedicated testbench and provided as fully verified
//ccx_module: DW_axi_a2x_bcm99 ; This module is verified in a dedicated testbench and provided as fully verified
//ccx_module: DW_axi_a2x_bcm57 ; This module is verified in a dedicated testbench and provided as fully verified
//ccx_module: DW_axi_a2x_bcm65 ; This module is verified in a dedicated testbench and provided as fully verified
//ccx_tgl : ; awsize_pp[2] ; ; This bit is toggled when A2X_PP_DW>=128
//ccx_tgl : ; arsize_pp[2] ; ; This bit is toggled when A2X_PP_DW>=128
//ccx_tgl : ; awsize_sp[2] ; ; This bit is toggled when A2X_SP_DW>=128
//ccx_tgl : ; arsize_sp[2] ; ; This bit is toggled when A2X_SP_DW>=128
...
// spyglass enable_block Topology_02
  ...
  parameter A2X_PP_SYNC_DEPTH = 0;
  parameter A2X_SP_SYNC_DEPTH = 0;
  ...
  parameter A2X_RS_AW_TMO = 1;
  parameter A2X_RS_AR_TMO = 1;
  ...
  localparam A2X_INT_NUM_AHBM               = A2X_NUM_AHBM+1;  // Dummy Master set to zero.    
  ...
  input  [`A2X_INT_LTW-1:0]                   awlock_pp;
  ...
  input  [`A2X_INT_LTW-1:0]                   arlock_pp;
  ...
  wire   [63:0]                               hincr_wbcnt_id;      // Setting to maximum of (15 Masters + Dummy Master) * Width(4)
  wire   [63:0]                               hincr_rbcnt_id;  

  wire                                        hclk           = 1'b0;
  wire                                        hresetn        = 1'b1;
  wire                                        hsel           = 1'b0;
  wire   [`A2X_IDW-1:0]                       hmaster        = {`A2X_IDW{1'b0}};
  wire   [A2X_PP_AWIDTH-1:0]                  haddr          = {A2X_PP_AWIDTH{1'b0}};
  wire                                        hwrite         = 1'b0;
  wire                                        hmastlock      = 1'b0;
  wire   [`A2X_HBLW-1:0]                      hburst         = {`A2X_HBLW{1'b0}};
  wire                                        hresize        = 1'b0;
  wire   [1:0]                                htrans         = 2'b00;
  wire   [`A2X_BSW-1:0]                       hsize          = {`A2X_BSW{1'b0}};
  wire   [`A2X_HPTW-1:0]                      hprot          = {`A2X_HPTW{1'b0}};
  wire   [A2X_PP_DWIDTH-1:0]                  hwdata         = {A2X_PP_DWIDTH{1'b0}};

  wire                                        hready         = 1'b1;
  wire                                        hready_resp;
  wire   [`A2X_HRESPW-1:0]                    hresp;
  wire   [A2X_PP_DWIDTH-1:0]                  hrdata;
  wire   [15:0]                               hsplit;

  wire   [A2X_INT_AWSBW-1:0]                  haddr_sb       = {A2X_INT_AWSBW{1'b0}};
  wire   [A2X_INT_WSBW-1:0]                   hwdata_sb      = {A2X_INT_WSBW{1'b0}};
  wire   [A2X_INT_RSBW-1:0]                   hrdata_sb;


  //-----------------------------AXI Interface------------------------------------------
    wire   [`A2X_IDW-1:0]                     wid_pp              ={`A2X_IDW{1'b0}};
    wire   [`A2X_SP_IDW-1:0]                  wid_sp;
    wire   [`A2X_LTW-1:0]                     awlock_core_pp      ={1'b0,awlock_pp};
    wire   [`A2X_LTW-1:0]                     arlock_core_pp      ={1'b0,arlock_pp};
  ...
  wire                                        cactive; 
  wire                                        busy_status;
  wire    [`A2X_INT_LTW-1:0]                  awlock_core_sp;
  wire    [`A2X_INT_LTW-1:0]                  arlock_core_sp;
