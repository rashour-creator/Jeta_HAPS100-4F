...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_h2x_lk.v#1 $ 
// --------------------------------------------------------------------
*/
...
// AHB Locked Control
//*************************************************************************************
module i_axi_a2x_1_DW_axi_a2x_h2x_lk (/*AUTOARG*/
   // Outputs
  ...
  input                                       hsel; 
  input  [`A2X_IDW-1:0]                       hmaster;
  input  [`A2X_IDW-1:0]                       hmaster_dp;
  input  [1:0]                                htrans;
  input                                       hwrite;
  input                                       hmastlock;
  input                                       hready;
