...
//
// Filename    : DW_axi_a2x_bcm07.v
// Revision    : $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_bcm07.v#18 $
// Author      : Vikas Gokhale       5/17/04
// Description : DW_axi_a2x_bcm07.v Verilog module for DW_axi_a2x
//
...
module i_axi_a2x_1_DW_axi_a2x_bcm07 (
        clk_push,
        rst_push_n,
        init_push_n,
        push_req_n,
...
`ifndef SYNTHESIS
  ...
  DW_axi_a2x_sva12_c P_RESET_PUSH(
    .clk(clk_push),
    .rst_n(rst_push_n),
    .init_n(init_push_n),
    .req_n(push_req_n)
  ...
  DW_axi_a2x_sva12_c P_RESET_POP(
    .clk(clk_pop),
    .rst_n(rst_pop_n),
    .init_n(init_pop_n),
    .req_n(pop_req_n)
