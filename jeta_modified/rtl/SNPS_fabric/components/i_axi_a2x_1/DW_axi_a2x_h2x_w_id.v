...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_h2x_w_id.v#1 $ 
// --------------------------------------------------------------------
*/
...
module i_axi_a2x_1_DW_axi_a2x_h2x_w_id (/*AUTOARG*/
  ...
  input  [`A2X_HBLW-1:0]                   hburst_dp;    // AHB burst             
  ...
  assign hburst_wrap       = ((hburst==`HBURST_WRAP4) || (hburst==`HBURST_WRAP8) || (hburst==`HBURST_WRAP16));
  assign htrans_nseq       = (htrans==`HTRANS_NSEQ);
  assign htrans_seq        = (htrans==`HTRANS_SEQ);
  assign htrans_idle       = (htrans==`HTRANS_IDLE);
  assign htrans_busy       = (htrans==`HTRANS_BUSY);

  assign hburst_dp_wrap    = ((hburst_dp==`HBURST_WRAP4) || (hburst_dp==`HBURST_WRAP8) || (hburst_dp==`HBURST_WRAP16));
