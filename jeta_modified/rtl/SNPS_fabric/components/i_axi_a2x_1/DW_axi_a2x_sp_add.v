...
// File Version     :        $Revision: #131 $ 
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_sp_add.v#131 $ 
**
** --------------------------------------------------------------------
**
...
module i_axi_a2x_1_DW_axi_a2x_sp_add (/*AUTOARG*/
  ...
  // SJ : BYPASS_WS is a parameter whose value is set as 1.
  ...
  localparam A2X_A_PYLD_W             = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +
                                        `A2X_HBTYPE_W +  A2X_ASBW  + `A2X_IDW +  A2X_AW   + `A2X_RSW + A2X_BLW + `A2X_BSW + 
                                        `A2X_BTW      + `A2X_LTW   + `A2X_CTW + `A2X_PTW;      

  // Resize FIFO Payload - Address Bits taken for the larger of the Data Busses
  localparam A2X_RS_PYLD_W            = (A2X_UPSIZE==1)?  (`A2X_RSW + `A2X_BSW + A2X_SP_NUM_BYTES_LOG2) : 
                                                          (`A2X_RSW + `A2X_BSW + A2X_PP_NUM_BYTES_LOG2);

  // Address Splitter fanns out alen
  localparam A2X_AS_PYLD_W            = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +
                                        `A2X_HBTYPE_W + A2X_ASBW + `A2X_IDW +  A2X_AW  + `A2X_RSW + BLW_AS + `A2X_BSW + 
                                        `A2X_BTW      + `A2X_LTW + `A2X_CTW + `A2X_PTW;

  // Address Resizer fanns out alen 
  localparam A2X_AR_PYLD_W            = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +
                                        `A2X_HBTYPE_W + A2X_ASBW + `A2X_IDW +  A2X_AW  + `A2X_RSW + BLW_RS + `A2X_BSW + 
                                        `A2X_BTW      + `A2X_LTW + `A2X_CTW + `A2X_PTW;

  // Used For Bypassing Address Calculator                                      
  localparam ALEN_PYLD_TO_BIT         = `A2X_BSW + `A2X_BTW      + `A2X_LTW   + `A2X_CTW + `A2X_PTW;
  localparam ALEN_PYLD_FROM_BIT       =  BLW_RS  + ALEN_PYLD_TO_BIT;

  // Used for Lock Transaction
  localparam ALOCK_PYLD_TO_BIT        =  `A2X_CTW + `A2X_PTW;
  localparam ALOCK_PYLD_FROM_BIT      =  `A2X_LTW + ALOCK_PYLD_TO_BIT;
  ...
  output [`A2X_BSW-1:0]                       ws_size; 
  output [`A2X_RSW-1:0]                       ws_resize; 
  output                                      ws_fixed;
  output                                      ws_last;
  output                                      w_snf_pop_en;
  ...
  wire   [`A2X_IDW-1:0]                       aid_i;             // Payload
  wire   [A2X_AW-1:0]                         aaddr_i; 
  wire   [A2X_BLW-1:0]                        alen_i; 
  wire   [`A2X_BTW-1:0]                       aburst_i;   
  wire   [`A2X_CTW-1:0]                       acache_i; 
  wire   [`A2X_PTW-1:0]                       aprot_i; 
  ...
  wire   [`A2X_BSW-1:0]                       asize_i;     
  wire   [`A2X_LTW-1:0]                       alock_i;   

  // Generated from Locked Control
  wire   [`A2X_LTW-1:0]                       alock_o;   
  ...
  if (BYPASS_AS==0) begin: ASBLK
    ...
    assign snf_pyld_w = (buf_mode==`SNF_MODE)? snf_pyld_i : 0; 
