...
// File Version     :        $Revision: #185 $ 
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_h2x.v#185 $ 
**
** --------------------------------------------------------------------
**
...
module i_axi_a2x_1_DW_axi_a2x_h2x (/*AUTOARG*/
   // Outputs
  ...
  wire  [`A2X_IDW-1:0]                        hmaster_dp;      // AHB Master ID Bus
  // These are dummy wires used to connect the unconnected ports.
  // Hence will not drive any nets.
  wire                                        hmastlock_dp;
  ...
  //*************************************************************************************
  i_axi_a2x_1_DW_axi_a2x_h2x_decode
   #(
  ...
  // Read Control. 
  //*************************************************************************************
  i_axi_a2x_1_DW_axi_a2x_h2x_resp
   #(
      .A2X_NUM_AHBM                       (A2X_NUM_AHBM)
     ,.A2X_SPLIT_MODE                     (A2X_SPLIT_MODE) 
  ) U_h2x_resp (
