...
//
// Filename    : DW_axi_a2x_bcm06.v
// Revision    : $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_bcm06.v#19 $
// Author      : Rick Kelly          04/14/04
// Description : DW_axi_a2x_bcm06.v Verilog module for DW_axi_a2x
//
// DesignWare IP ID: c7a15259
//
////////////////////////////////////////////////////////////////////////////////

module i_axi_a2x_1_DW_axi_a2x_bcm06 (
    clk,
    rst_n,
    init_n,
    push_req_n,
...
`ifndef SYNTHESIS
  ...
  DW_axi_a2x_sva12_b P_RESET_PUSH(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(push_req_n)
  ...
  DW_axi_a2x_sva12_b P_RESET_POP(
    .clk(clk),
    .rst_n(rst_n),
    .init_n(init_n),
    .req_n(pop_req_n)
