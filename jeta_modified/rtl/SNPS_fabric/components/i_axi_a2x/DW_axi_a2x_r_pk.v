...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_r_pk.v#1 $ 
// --------------------------------------------------------------------
*/
...
//
//*********************************************************
module i_axi_a2x_DW_axi_a2x_r_pk (/*AUTOARG*/
   // Outputs
  ...
  // Signal Decelaration
  //********************************************************* 
  wire  [`A2X_IDW-1:0]                   rid_i;    
  wire  [A2X_SP_DW-1:0]                  rdata_i; 
  wire  [`A2X_RRESPW-1:0]                rresp_i; 
  ...
  wire   [`A2X_BSW-1:0]                  pp_size;     
  wire                                   resize;
  wire                                   ws_last;
  wire                                   ws_fixed; 

  wire   [A2X_PP_NUM_BYTES_LOG2-1:0]     addr_i;
  wire   [`A2X_BSW-1:0]                  sp_size;
  wire                                   subsized;
  wire                                   shift_lsb;
  ...
  reg    [`A2X_RRESPW-1:0]               rresp_r; 
  wire   [`A2X_RRESPW-1:0]               rresp_w; 
 ...
 // assign pp_size_1hot[A2X_PP_MAX_SIZE:0] = pp_size_1hot_r[A2X_PP_MAX_SIZE:0];
  ...
  always @(*) begin: init_dec_PROC
    ...
    case (sp_size_1hot)
      ...
      //ccx_line: ; This line is covered in configurations with A2X_SP_DW >= 64 
      8'b00001000:  msb_dec = {{120{1'b0}}, {8{1'b1}}};
      //ccx_line: ; This line is covered in configurations with A2X_SP_DW >= 128
      8'b00010000:  msb_dec = {{112{1'b0}}, {16{1'b1}}};
      //ccx_line: ; This line is covered in configurations with A2X_SP_DW >= 256
      8'b00100000:  msb_dec = {{96{1'b0}}, {32{1'b1}}};
      //ccx_line: ; This line is covered in configurations with A2X_SP_DW >= 512
      8'b01000000:  msb_dec = {{64{1'b0}}, {64{1'b1}}};
      //ccx_line: ; This line is covered in configurations with A2X_SP_DW = 1024
  ...
  generate
    ...
    for (i = 0; i <A2X_PP_NUM_BYTES; i = i + 1) begin : pk_byte
      ...
      i_axi_a2x_DW_axi_a2x_r_pk_byte
  ...
  always @(*) begin: fifo_push_PROC
    ...
    case (pp_size_1hot)
      ...
      //ccx_line_begin: ; This line is covered in configurations with A2X_PP_DW >= 128
      8'b00010000: begin
      ...
      //ccx_line_end
      //ccx_line_begin: ; This line is covered in configurations with A2X_PP_DW >= 256
      8'b00100000: begin
      ...
      //ccx_line_end
      //ccx_line_begin: ; This line is covered in configurations with A2X_PP_DW >= 512
      8'b01000000: begin
      ...
      //ccx_line_end
      //ccx_line_begin: ; This line is covered in configurations with A2X_PP_DW = 1024
      8'b10000000: begin
