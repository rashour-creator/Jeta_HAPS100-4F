...
// File Version     :        $Revision: #78 $ 
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_ar.v#78 $ 
**
** --------------------------------------------------------------------
**
...
module i_axi_a2x_DW_axi_a2x_ar (/*AUTOARG*/
  ...
  localparam A2X_AR_PYLD_W            = A2X_BARW + A2X_RSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW + `A2X_HBTYPE_W + 
                                        A2X_ARSBW + `A2X_IDW +  A2X_AW   + `A2X_RSW + A2X_BLW + `A2X_BSW + 
                                       `A2X_BTW   + `A2X_LTW   + `A2X_CTW + `A2X_PTW;

  // Resize FIFO Payload - Address Bits taken for the larger of the Data Busses
  localparam A2X_RDS_PYLD_W            = `A2X_RSW + 1 + `A2X_BSW + A2X_PP_NUM_BYTES_LOG2 + 1; 
  ...
  wire   [`A2X_IDW-1:0]                       aid_i;             // FIFO Payload
