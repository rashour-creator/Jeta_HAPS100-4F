...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_b_nbuf.v#4 $ 
**
** --------------------------------------------------------------------
*/
//*************************************************************************************
...
module i_axi_a2x_DW_axi_a2x_b_nbuf (/*AUTOARG*/
   // Outputs
  ...
  generate
    if (BYPASS_UBID_FIFO==1) begin: UWID
      ...
      //ccx_cond: ; 2 ; 0 ; This condition can be covered when the write response buffer becomes full.
