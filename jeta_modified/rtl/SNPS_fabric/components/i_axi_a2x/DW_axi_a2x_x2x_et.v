...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_x2x_et.v#1 $ 
// --------------------------------------------------------------------
*/
...
//*********************************************************
module i_axi_a2x_DW_axi_a2x_x2x_et (/*AUTOARG*/
  // Outputs
  pyld_o, 
  // Inputs
  pyld_i, 
  ...
  if (WRITE_CH==1) begin : WRITE_CH_1
    ...
    // Strobe is representive of the Address and does not needs to be swapped. 
