...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_b_uid.v#4 $ 
**
** --------------------------------------------------------------------
*/
//*************************************************************************************
...
module i_axi_a2x_DW_axi_a2x_b_uid (/*AUTOARG*/
   ...
   bvalid_sp, bready_sp, b_pyld_sp, sp_rst_n
   );
  ...
  localparam A2X_B_W              = `A2X_IDW + `A2X_BRESPW;
  ...
  // Signal Decelaration
  //*************************************************************************************
  wire  [`A2X_IDW-1:0]                       bid_sp;
  wire  [`A2X_BRESPW-1:0]                    bresp_sp;
  ...
  //These nets are used to connect the logic under certain configuration.
  //But this may not drive some of the nets. This will not cause any functional issue.
  reg   [`A2X_BRESPW-1:0]                    uid_resp_r;
  wire  [`A2X_BRESPW-1:0]                    uid_resp;
