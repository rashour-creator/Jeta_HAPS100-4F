...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_core.v#122 $ 
**
** --------------------------------------------------------------------
**
...
module i_axi_a2x_DW_axi_a2x_core (/*AUTOARG*/
   // Outputs
  ...
  // set to zero.
  localparam A2X_INT_HASBW                  = (A2X_HASBW==0)? 1  : A2X_HASBW;   
  ...
  // Bresp Payload
  localparam A2X_B_PYLD_W                   = A2X_INT_BSBW + `A2X_IDW + `A2X_BRESPW;

  // AW payload in AXI
  localparam A2X_AW_PYLD_W                  = A2X_BARW + A2X_WSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW +`A2X_HBTYPE_W  +
                                              A2X_INT_AWSBW + `A2X_IDW + A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + 
                                              `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  // AW payload in AHB
  localparam A2X_AW_PYLD_W_AHB              = `A2X_HBTYPE_W + A2X_INT_AWSBW + `A2X_IDW + A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + 
                                              `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  // AR Payload in AXI                                     
  localparam A2X_AR_PYLD_W                  = A2X_BARW + A2X_RSNOOPW + A2X_DOMAINW + A2X_REGIONW + A2X_QOSW + `A2X_HBTYPE_W +
                                              A2X_INT_ARSBW + `A2X_IDW + A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + 
                                              `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  // AR Payload in AHB                                     
  localparam A2X_AR_PYLD_W_AHB              = `A2X_HBTYPE_W + A2X_INT_ARSBW + `A2X_IDW + A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + 
                                              `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
 // Primary & Secondary Port W Payload
  localparam A2X_W_PP_PYLD_W                = A2X_INT_WSBW + `A2X_IDW + A2X_PP_DW + A2X_PP_WSTRB_DW + 1;
  localparam A2X_W_SP_PYLD_W                = A2X_INT_WSBW + `A2X_IDW + A2X_SP_DW + A2X_SP_WSTRB_DW + 1;

  // Primary & Secondary Port R Payload
  localparam A2X_R_PP_PYLD_W                = A2X_INT_RSBW + `A2X_IDW + A2X_PP_DW + `A2X_RRESPW + 1;
  localparam A2X_R_SP_PYLD_W                = A2X_INT_RSBW + `A2X_IDW + A2X_SP_DW + `A2X_RRESPW + 1;
  ...
  localparam A2X_SP_OSAW_PYLD_W            = `A2X_RSW + 1 + `A2X_BSW + W_PP_NUM_BYTES_LOG2 + 1 + A2X_BLW + 1; 
  ...
  localparam A2X_RDS_PYLD_W                 = `A2X_RSW + 1 + `A2X_BSW + PP_NUM_BYTES_LOG2 + 1;                                            

  localparam A2X_RUS_PYLD_W                 = `A2X_RSW + 1 + BLW_PP + `A2X_BSW + 1 + A2X_SP_NUM_BYTES_LOG2;

  localparam A2X_SP_OSAR_PYLD_W             = (A2X_DOWNSIZE==1)? A2X_RDS_PYLD_W : (A2X_UPSIZE==1)? A2X_RUS_PYLD_W : `A2X_BSW; 

  localparam A2X_HINCR_LEN_W               = 4;

  // ID From-To Bits
  localparam AWID_FROM_BIT                  = `A2X_IDW + A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  localparam AWID_TO_BIT                    =  A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;

  localparam ARID_FROM_BIT                  = `A2X_IDW + A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  localparam ARID_TO_BIT                    = A2X_AW  + `A2X_RSW + A2X_BLW + `A2X_BSW + `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  
  localparam ARLEN_FROM_BIT                 =  A2X_BLW + `A2X_BSW + `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  localparam ARLEN_TO_BIT                   =  `A2X_BSW + `A2X_BTW + `A2X_LTW + `A2X_CTW + `A2X_PTW;
  ...
  input  [`A2X_BSW-1:0]                       hsize;       // AHB size              
  input  [`A2X_HPTW-1:0]                      hprot;       // AHB protection        
  input  [A2X_PP_DW-1:0]                      hwdata;      // AHB write data        

  input                                       hready;      // AHB ready
  output                                      hready_resp; // AHB ready                 
  output [`A2X_HRESPW-1:0]                    hresp;       // AHB response              
  output [A2X_PP_DW-1:0]                      hrdata;      // AHB read data             
  output [15:0]                               hsplit;      // AHB Split 
  input  [A2X_INT_AWSBW-1:0]                  haddr_sb;    // AHB Address Sideband Bus
  input  [A2X_INT_WSBW-1:0]                   hwdata_sb;   // AHB Write Data Sideband Bus
  output [A2X_INT_RSBW-1:0]                   hrdata_sb;   // AHB Read Data Sideband Bus
  ...
  output                                      awready_pp; 
  input                                       awvalid_pp;
  input  [`A2X_IDW-1:0]                       awid_pp;    
  input  [A2X_AW-1:0]                         awaddr_pp; 
  input  [A2X_BLW-1:0]                        awlen_pp; 
  input  [`A2X_BSW-1:0]                       awsize_pp;     
  input  [`A2X_BTW-1:0]                       awburst_pp;   
  input  [`A2X_CTW-1:0]                       awcache_pp; 
  input  [`A2X_PTW-1:0]                       awprot_pp; 
  input                                       awresize_pp;
  ...
  input                                       bready_pp; 
  output                                      bvalid_pp;     
  output [`A2X_IDW-1:0]                       bid_pp;       
  output [`A2X_BRESPW-1:0]                    bresp_pp;    
  ...
  output                                      arready_pp; 
  input                                       arvalid_pp;
  input  [`A2X_IDW-1:0]                       arid_pp;    
  input  [A2X_AW-1:0]                         araddr_pp; 
  input  [A2X_BLW-1:0]                        arlen_pp; 
  input  [`A2X_BSW-1:0]                       arsize_pp;     
  input  [`A2X_BTW-1:0]                       arburst_pp;   
  input  [`A2X_CTW-1:0]                       arcache_pp; 
  input  [`A2X_PTW-1:0]                       arprot_pp; 
  input                                       arresize_pp;
  ...
  output                                      rvalid_pp;   
  output                                      rlast_pp;   
  output [`A2X_IDW-1:0]                       rid_pp;    
  output [A2X_PP_DW-1:0]                      rdata_pp; 
  output [`A2X_RRESPW-1:0]                    rresp_pp; 
  ...
  input                                       awready_sp; 
  output                                      awvalid_sp;
  output [`A2X_SP_IDW-1:0]                    awid_sp;    
  output [A2X_SP_AW-1:0]                      awaddr_sp; 
  output [A2X_SP_BLW-1:0]                     awlen_sp; 
  output [`A2X_BSW-1:0]                       awsize_sp;     
  output [`A2X_BTW-1:0]                       awburst_sp;   
  output [`A2X_INT_LTW-1:0]                   awlock_sp;   
  output [`A2X_CTW-1:0]                       awcache_sp; 
  output [`A2X_PTW-1:0]                       awprot_sp; 
  ...
  output                                      bready_sp;
  input                                       bvalid_sp;     
  input [`A2X_IDW-1:0]                        bid_sp;       
  input [`A2X_BRESPW-1:0]                     bresp_sp;    
  input [A2X_INT_BSBW-1:0]                    bsideband_sp; 
  input [A2X_INT_BSBW-1:0]                    buser_sp;  
  // AXI Read Address
  input                                       arready_sp; 
  output                                      arvalid_sp;
  output [`A2X_SP_IDW-1:0]                    arid_sp;    
  output [A2X_SP_AW-1:0]                      araddr_sp; 
  output [A2X_SP_BLW-1:0]                     arlen_sp; 
  output [`A2X_BSW-1:0]                       arsize_sp;     
  output [`A2X_BTW-1:0]                       arburst_sp;   
  output [`A2X_INT_LTW-1:0]                   arlock_sp;   
  output [`A2X_CTW-1:0]                       arcache_sp; 
  output [`A2X_PTW-1:0]                       arprot_sp; 
  ...
  input                                       rvalid_sp;   
  input                                       rlast_sp;   
  input [`A2X_IDW-1:0]                        rid_sp;    
  input [A2X_SP_DW-1:0]                       rdata_sp; 
  input [`A2X_RRESPW-1:0]                     rresp_sp; 
  ...
  // Signal Decelaration
  //*************************************************************************************
  wire  [`A2X_IDW-1:0]                        awid_sp_w;
  wire  [`A2X_IDW-1:0]                        arid_sp_w;
  wire  [`A2X_IDW-1:0]                        wid_sp_w;
  wire  [`A2X_IDW-1:0]                        bid_sp_w;
  wire  [`A2X_IDW-1:0]                        rid_sp_w;
  ...
  wire                                        aw_last_sp;
  wire                                        aw_nbuf_sp; 
  wire   [`A2X_IDW-1:0]                       aw_id_sp;   
  wire   [`A2X_IDW-1:0]                       ar_id_sp;   
  ...
  wire [A2X_INT_WSBW-1:0]                     hwdata_sb_w;
  wire [A2X_INT_RSBW-1:0]                     hrdata_sb_w; 

  wire                                        wlast_pp_w;
  wire [`A2X_IDW-1:0]                         wid_pp_w;    
  ...
  wire  [`A2X_LTW-1:0]                        awlock_core_sp;
  wire  [`A2X_LTW-1:0]                        arlock_core_sp;
  ...
  //*************************************************************************************
  generate 
  if (`A2X_IDW==`A2X_SP_IDW) begin: IDW
    ...
    assign awid_sp   = {{(`A2X_SP_IDW-`A2X_IDW){1'b0}}, awid_sp_w};
    assign arid_sp   = {{(`A2X_SP_IDW-`A2X_IDW){1'b0}}, arid_sp_w};
    assign wid_sp    = {{(`A2X_SP_IDW-`A2X_IDW){1'b0}}, wid_sp_w};
    assign bid_sp_w  = bid_sp[`A2X_IDW-1:0];
    assign rid_sp_w  = rid_sp[`A2X_IDW-1:0];
  end
  endgenerate
  ...
  generate
    if((A2X_LOWPWR_IF==1) && ((A2X_BRESP_MODE==1) || (A2X_BRESP_MODE==2) || ((A2X_PP_MODE==1) && (A2X_BRESP_MODE==0)))) begin: PP_WR_OS
  ...
  generate 
    if (A2X_LOWPWR_IF==1) begin: LOWPWR
      i_axi_a2x_DW_axi_a2x_lp
       #(
         .LOWPWR_NOPX_CNT                       (A2X_LOWPWR_NOPX_CNT)
        ,.LOWPWR_RST_CNT                        (A2X_LOWPWR_RST_CNT)
      ) U_axi_a2x_lp (
      // Outputs
       .cactive(cactive),
                      .csysack(csysack),
                      .pp_rst_n(lp_pp_rst_n),
                      .sp_rst_n(lp_sp_rst_n),
     ...
     assign lp_pp_rst_n = 1'b1;
     assign lp_sp_rst_n = 1'b1;
     assign cactive     = 1'b1;
     assign csysack     = 1'b0;
     assign lp_mode     = 1'b0;
   end
  ...
  generate 
    if (A2X_PP_MODE==0) begin: H2X
      ...
      assign hwdata_sb_w = (A2X_WSBW==0)?  1'b0 : hwdata_sb;
      ...
      assign hresp        = {`A2X_HRESPW{1'b0}};
      assign hrdata       = {A2X_PP_DW{1'b0}};
      assign hsplit       = {16{1'b0}}; 
      assign hrdata_sb    = {A2X_INT_RSBW{1'b0}};
  ...
  assign wid_pp_w   = w_pyld_pp[A2X_W_PP_PYLD_W-A2X_INT_WSBW-1:A2X_W_PP_PYLD_W-A2X_INT_WSBW-`A2X_IDW];

  //*************************************************************************************
  // Write Path Instantiation
  //*************************************************************************************
  i_axi_a2x_DW_axi_a2x_w
   #(
      .A2X_PP_MODE                          (A2X_PP_MODE)
     ,.A2X_UPSIZE                           (A2X_UPSIZE)
     ,.A2X_DOWNSIZE                         (A2X_DOWNSIZE)
