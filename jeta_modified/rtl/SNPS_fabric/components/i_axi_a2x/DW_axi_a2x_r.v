...
// Revision: $Id: //dwh/DW_ocb/DW_axi_a2x/amba_dev/src/DW_axi_a2x_r.v#110 $ 
**
** --------------------------------------------------------------------
**
** File     : DW_axi_a2x_r.v
...
module i_axi_a2x_DW_axi_a2x_r (/*AUTOARG*/
   // Outputs
  ...
  localparam A2X_RUS_PYLD_W              = `A2X_RSW + 1 + BLW_PP + `A2X_BSW + A2X_SP_NUM_BYTES_LOG2 + 1;
  ...
  i_axi_a2x_DW_axi_a2x_fifo
   #(
    ...
    ,.PUSH_SYNC_DEPTH                        (A2X_SP_SYNC_DEPTH)
    ,.POP_SYNC_DEPTH                         (A2X_PP_SYNC_DEPTH)
  ...
  genvar i;
    if (BYPASS_URID_FIFO==0) begin: URID_EN 
      ...
      // care about the ID. 
      //ccx_cond: ; 2 ; 0 ; This condition can be covered when the read data buffer becomes full.
